...
\renewcommand{\lsImpressumExtra}{Revised Ph.\,D. thesis, University of Marburg, Department of German Studies and Arts, accepted in September 2022}
...
\newcommand{\SObj}[1]{%
  \notblank{#1}{%
    \textsc{obj}\textsubscript{#1}%
  }{%
    \textsc{obj}\textsubscript{θ}%
  }%
}
\newcommand{\Oblq}[1]{%
  \notblank{#1}{%
    \textsc{obl}\textsubscript{#1}%
  }{%
    \textsc{obl}\textsubscript{θ}%
  }%
}

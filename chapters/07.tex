...
und indirekten Bezug auf einzelne Plural-Controller (N\tsub{i}) machen. Die
...
Controller. Auch in Hinblick auf den Wortformenabstand\is{Distanz!lineare}
zwischen \q{Erstcontrollern}\is{Erstcontroller} und \norm{bėide}-Targets ändert
...
\isi{Distanz} zwischen Controller und Target gegenüber \norm{bėidiu} `beide
(\textsc{n})' dominiert.

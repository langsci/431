...
(Substantive, Pronomina) wie zum Beispie \norm{her R\sscrit{v}{o}diger vnd ſin hovſfrowe}
...
\ex \label{ex:beid2coordncao1}
		\gll swenne aber her R\sscr{v}{o}diger vnd ſin
...
\ex \label{ex:beid2coordncao2}
	...
	% \ex \label{ex:beid2coordncao2_2}
		\gll Jch seibot von freihaim / vnd fr\sscr{a}{v}we Peters mein
			Havſfr\sscr{a}{v}we / veriehen beidev vnd t\sscr{u}{o}n chvnt \\
...
Beispiel nur noch \lit{endru g\sscrit{u}{o}t} \wdef{andere Güter (\textsc{nom.pl.\NeutI})}
...
\ex \label{ex:beid2coordncao1_2}
	\gll Diſ dingeſ gezuga ſint · R\sscr{u}{o}d · von der palma
			min \sscr{O}{e}hen · \sscr{v}{o}lrich von Gr\sscr{v}{e}nenberch min \sscr{O}{e}hen bedu Jungherren
			\textelp{} \\
		Dies Verhandlung-\textsc{gen.sg.\NeutI} Zeugen sind {}
			\lit{R\sscrit{u}{o}d}[\textsc{nom.sg.\MascM}] {} von der Palme mein Oheim {}
			Ulrich[\textsc{nom.sg.\MascM}] von Grünenberg mein Oheim
			beide-\textsc{nom.pl.\NeutM.st}
			Jungherren[\textsc{nom.pl.\MascM}] {} \\
	\trans \wdef{Zeugen dieser Verhandlung sind: \lit{R\sscrit{u}{o}d} von der Palme,
...
\ex \label{ex:cao_diffgend_13_beide}
	...
	% \ex \label{ex:cao_diffgend_13_beide_1}
		\gll Jch G\sscr{o}{v}ta \textelp{} do kunt \textelp{} daſ ich mit mineſ
	...
	% 	\gll Jch R\sscr{v}{o}dolf \textelp{} vnde Adelheit min wirtin / t\sscr{v}{e}n
...
\ex \label{ex:vvfinctrl}
	...
	% 	\gll wir leben \textelp{} vn̄ {} ſuln daſ ſelbe g\sscr{u}{o}t beidú nieſſen \\
...
% 		\gll B˜chart vn̄ C\sscr{v}{o}nrat von lv̓ſtenowe \textelp{} vn̄ {} hant dc beide
...
\ex\label{ex:1843_kinde}
	...
	\gll Jch \sscr{V}{o}lrich \textelp{} kvnde \textelp{} daz ich mit g\sscr{u}{o}tem rathe
...
C\sscrit{v}{o}nrat der Bodemer} \autocites(Nrn.~1201~AB)[472,7]{cao2}.
...
% 	) enthält dafür \lit{ſch\sscrit{v}{o}l chint} \wdef{Schulkinder} und ebenso \lit{diſiv
...
\ex \label{ex:beid2p2snglncao}
	\gll vnd ſol ez den zwein wr\sscr{o}{v}wen gen biz an ir beider tot / ſo
...
\lit{kinden} \wdef{Kindern} und \lit{ſ\sscrit{v}{i} beid\sscrit{v}{i}} \wdef{sie beide} angenommen.

\begin{exe}
\protectedex{%
\ex \label{ex:cao_beidiu_neutunkn}
	\gll mit zewain kinden \textelp{} daz ſvn ſ\sscrit{v}{i} beid\sscrit{v}{i} han vnze an ir tôt
			\textelp{} vn̄ ſwen ſ\sscrit{v}{i} beid\sscrit{v}{i} {en ſîn} \textelp{} \\
...
\ex\label{ex:n241_hofzehnt}
	...
	\gll daz ich minen frowen von ſande Katerinen minen hof, den ich ze
			...
			mit dem zehenden, der drovz gat, beidev vnuerſchaidenlichen f\sscr{v}{e}r
			reht aigen \\
...
\ex\label{ex:insigel}
	\gll Daz deſ niht vergezzen werde {dar vmb} iſt gemachet dirre brief
			...
			mit vnſerm Jnſigel d\sscr{ı}{e}v baid\sscr{ı}{e}v dran hangent \\
...
\ex \label{ex:caokonj2ctrl}
	...
	\ex \label{ex:caokonj2ctrl_3}
		\gll beidv er / vn̄ \sscr{o}{v}ch alle die / den er ſ\sscrit{v}{i} gît \\
...
Evidenz für \isi{Genusresolution} dienen? \citet[187]{gjelsten1980} räumt in
...
\ex \label{ex:caobeidkoordtarg}
	...
	\ex \label{ex:caobeidkoordtarg_3}
		\gll vnde hat {div ſelben} g\sscr{v}{o}t \textelp{} aller anſprache /
...
\ex \label{ex:caokoordsyn}
	...
	\ex \label{ex:caokoordsyn_1}
		\gll beide vor vn̄ n\sscr{o}{e}ch \\
			beide vor und nach \\

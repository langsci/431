...
Umgebung (vornehmlich aus Kloster Altenhohenau, ebenfalls Kr.~Rosenheim)
ist \lit{-iu/eu} als Flexionsform für den Nom./Akk.\ Pl.\ N.\ zumindest bei
Determinierern wie \norm{alliu} `alle (\textsc{pl.n})', \norm{disiu} `diese
(\textsc{pl.n})', oder \norm{unseriu} `unsere (\textsc{pl.n})' etabliert.

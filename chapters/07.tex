...
Urkunden befindet sich in \sectref{subsec:ausgewurk}. Der alemannische Raum ist
...
im \CAO{} (Hintergrundkarte: \cite{wiesinger1983:rede})}
...
Urkunden werden in \sectref{subsec:ausgesurk} aufgeführt. Bei der Besprechung
...
Geschlecht (\sectref{subsubsec:perscombsgnp}) nicht bezeugt ist, sind Belege für
...
nicht in \tabref{tab:caosimprefctrl} aufgenommen.
...
\ex\label{ex:682_insigel}
	...
	\gll Tougen wir abt vollant / vnd Bertholt der prior / vnd der Conuent von
		...
		tun wir Abt Volland[\textsc{nom.sg.\MascM}] {} und Berthold[\textsc{nom.sg.\MascM}]
			der Prior {} und der Konvent[\textsc{nom.sg.\MascM}] von Hirsau kund {}
			Darum heben \textsc{1pl\subM.nom} an diesen Urkunde
			\textsc{1pl\subM.gen} beide-\textsc{acc.pl.\NeutI.st}
			Siegel[\textsc{acc.pl.\NeutI}] {} und Graf-\textsc{gen.sg} Albrecht-\textsc{gen} von
			{} Hohenberg \\
...
\tabref{tab:caosiebeidekombis} zeigt die im \CAO{}-Material belegten
...
gegenüber sowohl \norm{bėide} als auch \norm{bėidiu} beim Quantor vertreten
sind, sieht man von der geringeren Belegzahl insgesamt ab.
...
Präpositionalphrasen \crefrange{ex:caokoordsyn_2}{ex:caokoordsyn_3} vor.

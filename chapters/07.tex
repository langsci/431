...
\begin{xlist}
	...
	% 		Wir Jakob und Heinrich {} dessen geben \textsc{1pl\subM.nom} beide-\textsc{nom.pl.\MascM.st} diesen Urkunde den vorgenannten Frauen \\
...
% 		Otto[\textsc{nom.sg.\MascM}] der Kreuzer {} und Wilbirg sein Ehefrau {} die
% 		Weile \textsc{3pl\subMF.nom} beide-\textsc{nom.pl.\NeutMF.st} leben \\

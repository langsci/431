...
bestätigen\is{Validierung} die in \citet[626--627]{ksw2} formulierte
...
mit koordinierten Targets\is{Target} wird eine eindeutige Abhängigkeit der Form
der \isi{Konjunktion} von den Personenmerkmalen\is{Personenmerkmal} der
Konjunkte deutlich.\is{Koordination} Dass der Aspekt von \norm{bėide} als

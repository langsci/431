...
Kontext in der Stichprobe nicht belegt ist.
...
Beim unbelebten\is{Inanimata} Bezug dagegen ist kein entsprechender Unterschied
zu beobachten.
...
der Tabelle, der unbelebte\is{Inanimata} Elemente mit unterschiedlichem
\isi{Genus} enthält, wird anders als zuvor \norm{bėidiu} nicht klar
favorisiert: Mit 58\,\% für \norm{bėidiu} sind die Verhältnisse nahezu
ausgeglichen. Insgesamt ergibt sich keine klare, von Personenmerkmalen
...
verschiedenem unbelebten\is{Inanimata} \isi{Genus} steht in den vereinzelten
belegten Fällen \norm{bėidiu}.
...
unbelebten\is{Inanimata} Targets mit unterschiedlichem \isi{Genus} steht in
64\,\% der Belege \norm{bėidiu}.

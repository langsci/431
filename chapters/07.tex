...
\isi{Erstcontroller} mit gleichem Genus ergibt sich in \tabref{tab:caosimprefctrl}
...
\norm{bėide} auf zwei \isi{Erstcontroller} mittels eines Pronomens (PRO\tsub{i+j}).
Hier liegen für den indirekten Bezug auf zwei belebte\is{Animata}
\isi{Erstcontroller} von gleichem Geschlecht ausschließlich Belege für \norm{bėide}
...
Beim indirekten Bezug auf kombinierte unbelebte \isi{Erstcontroller} vom gleichen
...
Kombination unbelebter \isi{Controller} unabhängig von deren Genus. Die
Vermutung, dass mit wachsendem \isi{Abstand} die spezifische Information
\q{Menschen von unterschiedlichem Geschlecht}, die Gender Resolution bei
Targets hin zum Neutrum auslöst, von der unspezifischeren Information
\q{Menschen} verdrängt wird, hat sich im untersuchten Material des \CAO{} nicht
bestätigt. Es ließ sich also nicht beobachten, dass \norm{bėide} `beide
(\textsc{m+f})' mit wachsender \isi{Distanz} zwischen \isi{Controller} und

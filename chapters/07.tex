...
koordinierten\is{Koordination} nominalen Ausdrücken (Substantive, Pronomen) wie
zum Beispie \norm{her Rvͦdiger vnd ſin hovſfrowe} `Herr Rüdiger und seine
Ehefrau' in \REF{ex:beid2coordncao1} und dem Schema in
\figref{fig:beid2coordncao1_1} näher betrachtet. Dabei werden Kombinationen von
\isi{Personalpronomen} und Eigenname wie \norm{ich unde Ulrich} an dieser Stelle
...
substantivisches \isi{Antezedens} beziehen und dessen Personenmerkmale
reflektieren.
...
geben \REF{ex:beid2p2snglncao} und die Illustration der
...
\isi{Belebtheit} der Substantive eine wichtigere Rolle als deren \isi{Genus} zu
...
können keine gemacht werden, da dieser Kontext in der \isi{Stichprobe} nicht
belegt ist.
...
Bezugs auf zwei unbelebte\is{Inanimata} Substantive von unterschiedlichem
Geschlecht ist nur die Form \norm{bėidiu} belegt. Insgesamt scheint in diesem
Kontext also die Form \norm{bėidiu} unabhängig vom \isi{Genus} bevorzugt zu
werden.
...
Einfluss der Personenmerkmale\is{Personenmerkmal} auf die Form von \norm{bėide}
in \sectref{subsubsec:beid2p2snglncao} ändert sich also ebenfalls nichts.

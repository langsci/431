	...
	\ex \label{ex:remgenbeide_1}
		\gll % von den luitín
			...
			die ihr-\textsc{gen.pl} beide-\textsc{gen.pl}
				Nachbarn-\textsc{nom.pl.\MascA} sind \\
		\trans `%
			%von den Leuten,
			die ihr beider Nachbarn\footnotemark{} sind' (%
		...
		%
		\footnotetext{Mhd.~\norm{gevurche} `Furchgenosse, Nachbar',
			siehe \citet[s.\,v.~\fw{gevurche}]{mwb2}. Danke an Jonas Richter
			(Göttingen) für den Hinweis.}

...
ebenfalls zugunsten der neutralen Form ausfällt. Die Beispiele für diesen
Kontext in \REF{ex:cao_diffgend_13_beide} stammen aus% Basel (1273%
dem niederalemannischen\il{Alemannisch} Dialektgebiet.
...
Die Beispiele in \REF{ex:cao_diffgend_11_beide} illustrieren den Kontext; es
handelt sich um die verbleibenden Belege.
...
auch][419]{dalrymple2001}[210]{bresnanetal2016}.
...
Erstcontroller mit gleichem Genus ergibt sich in \tabref{tab:caosimprefctrl} ein
...
kombiniertem maskulinem Bezug zu finden \REF{ex:cao_samegend_inan_mm_beidiu}.
...
Der Beleg in \REF{ex:cao_samegend_inan_mm_beidiu_1} -- bis auf kleine
...
finden ließen, ergab eine kurze Recherche im \REM{} die drei in
\REF{ex:beid2p2combrem} zitierten Belege, allerdings stammen zwei davon
aus gereimten Texten. Alle drei Stellen enthalten die neutrale Form
\norm{bėidiu} mit Bezug auf kombinierte unbelebte Feminina.
...
\citet{lachmannhartl1952}. \tabref{tab:asksiebeidekombis} gibt die Ergebnisse
...
einbegriffen}, also Kontexte, in denen der Vokal des Flexionssuffixes im Hiatus
oder am Zeilenende steht. Aus den einzelnen Belegen in
\tabref{tab:asksiebeidekombis} eine Regel abzuleiten, ist allerdings höchst
fragwürdig.
...
Markierung von Genus an einem der beiden Glieder grammatikalisiert ist.
% Eine Abhängigkeit der Kongruenzform von \norm{bėide} von der Wortform des
...
als die sehr kleine Stichprobe von \citeauthor{askedal1973}. Die Häufigkeit von
...
mehr nach der Feinbestimmung ihrer Personenmerkmale aufgelistet, sondern nach
Belebtheit und gleichem oder verschiedenem Geschlecht beziehungsweise Genus.
...
Referenz aus Belegen wie dem in \REF{ex:insigel} handelt. Formulierungen
...
%
	...
	Jnſigel zu auſpurch div baidiv dran hangent} \autocites(Nr.~N~272,

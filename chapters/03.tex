...
In \cref{ex:beidejohahd_1} dient \lit{péidíu} `beide' der Ankündigung, dass die
...
\cref{ex:beidejohahd_3}, bei der \lit{béidíu} `beide' sowohl Katapher als auch
...
\cref{ex:beideintiahd_3} ist, dass \lit{pediu} `beide' schon mit

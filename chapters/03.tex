...
\REF{ex:beidejohahd} für das Althochdeutsche ergeben. \citet{braune2018} und
...
`klein' bezieht und daher im Plural Neutrum steht. In \REF{ex:beidejohahd_2}
...
\REF{ex:beidejohahd_3}, bei der \lit{béidíu} `beide' sowohl Katapher als auch
Konjunktion sein kann. Ob \lit{béidíu} in diesem Fall tatsächlich nach dem
Genus der Konjunkte flektiert, wurde nicht weiter untersucht. Auffällig an
\REF{ex:beideintiahd_3} ist, dass \lit{pediu} `beide' schon mit

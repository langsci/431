...
\isi{Stichprobe} anhand der automatischen Annotation\is{Annotation}\is{Tagging}
des \tit{Corpus der altdeutschen Originalurkunden} (\CAO) nach
\citet{schmid2019} nicht gefunden werden. Auch eine manuelle Durchsicht der
hier verwendeten \tit{Kaiserchronik}-Handschriften (\KC) ergab keine Treffer.
\citet[626]{ksw2} nennen zumindest die zwei Beispiele in \REF{ex:gendatconj}
aus literarischen Texten, die dort \textquote{noch} vorkommen.

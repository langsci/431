...
und Färöischen\il{Färöisch} \autocite[225--226]{thrainsson2004} erhalten
geblieben. In \REF{ex:germbeide} werden zur Illustration einige Beispiele aus
...
\caption{Flexionsendungen starker Adjektive im Nom.~Sg.~F. und Nom./Akk.~Pl.\
		des Färöischen\il{Färöisch}, Isländischen
		% , Alt-
...
überschneidet, wie im Isländischen und Färöischen\il{Färöisch}. Nimmt man den
Akkusativ hinzu, fällt auch der Nom.~Pl.~M./F.\ (\norm{-e}) mit dem
Akk.~Pl.~M./F.\ und dem Akk.~Sg.~F.\ zusammen (vgl.~auch

...
`beide (\textsc{nom+acc.pl.n.st})' in mittelhochdeutschen Quellen untersucht
wird, handelt sich um eine bekannte Eigenheit der germanischen\il{Germanisch}
Sprachen. Diese zeigt sich insbesondere in den älteren Sprachstufen, ist
darüber hinaus aber noch im modernen Isländischen\il{Isländisch}
\autocites[283]{corbett1991}[569]{wechsler2009} und Färöischen\il{Färöisch}
\autocite[225--226]{thrainsson2004} erhalten geblieben. In \REF{ex:germbeide}
werden zur Illustration einige Beispiele aus historischen\is{Diachronie}
Quellen präsentiert.%
%
...
\isi{Attribut}, das \isi{Prädikat} und das aufnehmende Pronomen im Neutrum
...
diachronen\is{Diachronie} Entwicklung dieses Phänomens vom Althochdeutschen bis
zur \q{Blütezeit} der mittelhochdeutschen Epik um 1200
...
\begin{itemize}
	...
	\item als Begründung für die Kongruenzregel entweder nur
		\q{formale}\is{Kongruenz!formale} (das heißt morphologische?) Aspekte
		oder in der Tradition der Junggrammatiker\is{Junggrammatik} die reine
		Lautentwicklung angeführt werden.
\end{itemize}

\citet{askedal1973} geht es bei seiner Studie nicht nur um
\norm{bėidiu}, sondern um den größeren Kontext des Verlusts der
Genusopposition\is{Genus} zwischen Maskulinum-Femininum und Neutrum im
...
Wichtig an \citeauthor{askedal1973}s Arbeit ist der Versuch, \fw{\isi{Gender
...
\norm{-iu} durch \isi{Apokope} des adjektivischen\is{Adjektiv} Flexionsmorphems
zur Vermeidung eines \isi{Hiatus} aufgehoben wird.%
%
...
zwischen der Kombination von gleichen und verschiedenen Genera\is{Genus} sowie
...
also rückverweisend auf zwei im Kontext\is{Pragmatik} bereits etablierte
...
\end{exe}
%
	\footnotetext{Das Substantiv\is{Substantiv} \norm{art}, u.\,a. `Herkunft,
		Abstammung, Gattung', ist sowohl als Maskulinum als auch als Femininum
		belegt \autocite[s.\,v.~\textit{art}]{mwb1}. Ausweislich der Flexion
		des vorausgehenden Possessivbegleiters handelt es sich an der zitierten
...
auf unbelebte\is{Inanimata} Referenten mit verschiedenem \isi{Genus} kommen
...
Bezug auf unbelebte\is{Inanimata} Referenten mit gleichem \isi{Genus} steht
...
sei, was den Verlust der Genusdistinktion im Plural\is{Genusdistinktion, Abbau
der} befördere. Die Ausweitung der maskulin-femininen Form in der
adjektivischen Plural\-flexion\is{Adjektivdeklination} stelle darüber hinaus
eine Zwischenstufe zur vollständigen Beseitigung der Genusflexion im Plural
dar.
...
[\textsc{±\,f, ±\,n}] zur paradigmatisch-struktu\-rellen\is{Paradigma}
Definition der Genera\is{Genus} an. Dass das Maskulinum in der deutschen
Grammatik grundlegender ist als das Femininum macht er daran fest, dass
...
europäischen Sprachen, dass nicht allein paradigmatische\is{Paradigma} oder
semantische \q{Unmarkiertheit}\is{Markiertheit} den Ausschlag zur Wahl eines
bestimmten Genus\is{Genusmarkierung} als Ergebnis von \isi{Gender Resolution}
gebe \autocite[290--293]{corbett1991}, sondern dieses
\q{Resolutionsgenus}\is{Gender Resolution} in jedem Fall eine semantische
Motivation\is{semantische Motivation} benötige und die Plural\-kategorie
möglichst klar kennzeichnen sollte \autocite[293--299]{corbett1991}. Am
Beispiel des Isländischen\il{Isländisch}, das ein dreigliedriges
Genussystem\is{Genus} mit dem Neutrum als Resolutionsgenus\is{Gender
Resolution} besitzt \REF{ex:icelgendres}, zeigt er, dass grammatisch neutrale
Bezeichnungen in Bezug auf Menschen\-gruppen oder im Geschlecht nicht
festgelegte Personen in der Sprache vorkommen, was das Neutrum als Möglichkeit
zum Ausgleich von Genusmerkmalen\is{Genusmerkmal} legiti\-miere.
...
Normalisierungs\-praxis\is{Normalisierung} älterer
...
syntaktischen Einheit, über die die \isi{Fokuspartikel} Skopus hat, ist
...
verdeutlichen, dass die vom Adverb eingeleitete NP\is{Nominalphrase} den
\isi{Fokus} des jeweiligen Satzes darstellt.
...
ich an, dass \lit{péidíu} sich hier auf die prädikativen
Adjektive\is{Adjektiv!prädikativ} \lit{míchel} `groß' und \lit{lúzzel} `klein'
bezieht und daher im Plural Neutrum steht.\is{Kongruenz!prädikative}
...
`und' auffällig, dass \lit{pediu} `beide' schon mit
Präpositionalphrasen\is{Präpositionalphrase} steht (\lit{in demo lihnamen} `im
Körper', \lit{in demo muôte} `im Geist'), die als solche keine
...
einer \isi{Stichprobe} anhand der automatischen Annotation\is{Annotation} des
...
%
	\footnotetext{Die Formen \lit{der boſten} und \lit{der besten} sind
		...
		Geringste}. Denkbar wäre also die Ellipse eines
		Substantivs\is{Substantiv} wie \norm{dinc} `Ding, Sache
		(\textsc{pl.\NeutI})'.%
	}
...
enthält ihr \isi{Korpus} nur verhältnismäßig wenige Urkunden\is{Urkunde} aus
dem 13.\ und 14.\ Jahrhundert. Durch den Vergleich der Urkundenbelege mit der
\tit{Mittelhochdeutschen Grammatik} lässt sich die
Zuverlässigkeit\is{Validierung} des \CAO{} vor dem Hintergrund der
\isi{Überlieferung} überprüfen, zumal sich Urkunden besonders durch ihre
kleinräumige Auflösung hervortun. Umgekehrt lassen sich
geografische\is{Dialektgeografie} Angaben der Grammatik zumindest für das späte
13.~Jahrhundert mit dem \CAO{} anhand seiner relativ klar lokalisierbaren Daten
verifizieren. Die \KC{} ist andererseits aufgrund ihres langen
Tradierungs\-zeitraums reizvoll, um auch die diachrone\is{Diachronie}
Perspektive zumindest im Ansatz zu untersuchen -- aufgrund ihrer regionalen
Verbreitung hauptsächlich im bairischen\il{Bairisch} Sprachgebiet.

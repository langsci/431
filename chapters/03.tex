...
und \norm{bėidiu} anaphorisch oder kataphorisch auf, also rückverweisend auf
...
Konstruktion \norm{bėide \dots\ unde} `sowohl \dots\ als auch' aus einer
...
\lit{míchel} `groß' und \lit{lúzzel}
...
Präpositionalphrasen steht (\lit{in demo lihnamen} `im Körper',
\lit{in demo muôte} `im Geist'), die als solche keine Personenmerkmale
...
%
	\footnotetext{Die Formen \lit{der boſten} und \lit{der besten} sind ambig
		...
		eines Substantivs wie \norm{dinc} `Ding, Sache (\textsc{n.pl})'.%
	}

...
\norm{bėidiu} des mittelhochdeutschen\il{Mittelhochdeutsch} determinativen
...
die nicht notwendigerweise das gleiche Genus besitzen. Im Vordergrund steht
dabei die Quantifizierung von Variation zwischen den beiden Wortformen beim
...
wobei noch zu klären wäre, ob die vertretenen Texte tatsächlich beide Formen,
...
%
Die genannten Versromane besitzen, genau wie die \KC, eine vielfältige und
komplexe \isi{Überlieferung} besitzen (\cite[vgl.][s.\,v.~\textit{\iai{Hartmann
von Aue}: \tit{Iwein}}, \textit{\iai{Wolfram von Eschenbach}:
\tit{Parzival}}]{hsc} sowie die dort verzeichnete Literatur). Um die
Handhabbarkeit der auszuwertenden Texte auch aus philologischer Sicht zu
gewährleisten, beschränkt sich diese Arbeit exemplarisch auf die jetzt digital
verfügbare \KC{} als literarisches Gegengewicht zum \CAO{}.\is{Desiderat}
...
\ex \label{ex:mhgbeide}
	\gll Her Ernst \textelp{} vnd \textelp{} ver Gerdroͤvt \textelp{}
			da ſi baide lebten \\
		%
...
Unter\-suchung anhand von Vers\-texten\is{Vers} in dieser Arbeit eine größere
Menge gebrauchsschriftlicher\is{Gebrauchssprache} Prosatexte\is{Prosa} zur
...
die Anzahl oder Menge des von ihm bestimmten Substantivs spezifiziert
(vgl.~\sectref{phsec:quantdist})~-- kommt im

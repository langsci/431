...
gleiche Genus besitzen. Im Vordergrund steht dabei die \isi{Quantifizierung}
von Variation zwischen den beiden Wortformen beim gleichzeitigen Bezug auf
...
nützlich, um vor allem den Unterschied zwischen
semantischer\is{Kongruenz!semantische} und formaler
Kongruenz\is{Kongruenz!formale} über den Abgleich entsprechender
grammatischer\is{Merkmale!grammatische} und semantischer
...
auszugsweise verschiedenste Reim-\is{Vers} und Prosatexte\is{Prosa} aus dem
...
Resolutionsgenus beziehungsweise \fw{\isi{Default}}
...
\centering
\caption%
	{Ausschnitt der althochdeutsch (pronominal-)starken Adjektivflexion
	\autocites[vgl.][300]{braune2018}}
...
Straßburg\ia{Gottfried von Straßburg} anhand der Edition von
...
spezifizieren\is{Quantifizierung} können. Bezug auf Gruppen und Mengen haben
auch die adjektivisch deklinierenden\is{Adjektivdeklination} Lemmata \norm{al}
`alle' sowie die Pluralformen von \norm{manic} `viel', \norm{ętelich}
`(irgend)ein, irgendwelch' oder \norm{sumelich} `irgendein, manch, mancherlei'.
Gerade bei \norm{bėide} erfolgt aber häufig die Nennung seiner zwei Referenten,
während im untersuchten Material \norm{al} oft auf einzelne
Substantive\is{Substantiv} im Plural bezogen ist, die im Bezug auf Kongruenz
tendenziell unproblematisch sind (\sectref{sec:beidequant}). Zu beachten ist
auch die Häufigkeit\is{Frequenz} der Lemmata selbst, die in
\tabref{tab:freqquantcao} für das \CAO{} basierend auf den Angaben des \WMU{}
angegeben ist. Davon flektiert jeweils nur ein Teil stark für den hier
relevanten Nom./Akk.~Pl.
...
referenzierten Personenmerkmalen\is{Personenmerkmal}, nach der Distanz in
...
Diskussion der quantitativen Verteilung der Belege werden Ausnahmen und
sonstige Auffälligkeiten auch qualitativ eingeordnet, indem erörtert wird, wie
diese zustande kommen können.
...
\fw{Sie promovieren \emph{beide} in Sprachgeschichte}, auffällig häufig

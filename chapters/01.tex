...
Bedingungen geforscht, die die beobachtete Variation motivieren oder
begünstigen.
...
als auch' 103 Belege für \norm{bėide} und 217 für \norm{bėidiu}. Für die zwei
Funktionen von \norm{bėide} sind also insgesamt 637 Belege verfügbar -- wobei
noch zu klären wäre, ob die darunter vertretenen Texte tatsächlich beide
...
noch im Isländischen\il{Isländisch} \REF{ex:modgermbeide_1} und im
...
Appositionskonstruktion \norm{bėide, \emph{X} unde \emph{Y}} vorliegt.

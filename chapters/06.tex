...
Adjektivflexion, wie es allgemein für das Oberdeutsche zu
...
\caption{(Pronominal-)Starke Adjektivflexion in oberdeutschen Schreibdialekten
	des Mittelhochdeutschen\il{Mittelhochdeutsch} nach \citet[182, Abb.
	A~3]{ksw2}}
...
\caption{Nominal-starke Adjektivflexion in oberdeutschen Schreibdialekten des
	Mittelhochdeutschen\il{Mittelhochdeutsch} nach \citet[182, Abb. A~3]{ksw2}}
...
auch in Hinsicht auf die auszuwertenden \KC{}-Handschriften
(vgl.~\figref{fig:adjstpr_orte}).
...
Bairischen\il{Oberdeutsch!Bairisch} wurden dabei außer Acht gelassen, zumal
...
Für das Alemannische\il{Oberdeutsch!Alemannisch} weisen \citet[271, Abb.\
...
13.~Jahrhunderts im Alemannischen\il{Oberdeutsch!Alemannisch} belegt ist
...
\lit{-e} und \lit{-u/-ú} vertreten sind \REF{ex:adjbaselregel}. Für den Akk.\
Pl.\ N.\ ist jeweils ein Beleg für \norm{-iu} und einer für \norm{-e} in der
Stichprobe enthalten \REF{ex:adjbaselu}.
...
\lit{-e} und \lit{-ú} repräsentiert sind \REF{ex:adjzuerregel}. Für den Nom.\
Sg.\ F.\ ist in der Stichprobe sowohl ein Beleg für \norm{-iu} als auch für
\norm{-e} enthalten \REF{ex:adjzueru}. Diese stammen allerdings nicht aus
...
\norm{iu}-Typen auf \REF{ex:adjkonstregel}, letztere treten auch grafisch als
...
\REF{ex:adjkonstesg} sowie viermal im Nom.\ Pl.\ M.\ \REF{ex:adjkonstepl}.
...
\REF{ex:adjwienakksgf_4}. Auch hier muss wohl eine Ausweitung der Neutrumsform
...
Mitteldeutschen \autocites[181]{ksw2}[vgl.~auch][832]{wiesinger1983}. Die
...
aufgehoben, wie in \REF{ex:kchregel} illustriert. Belege für den Plural
Femininum sind in der Stichprobe keine vorhanden.
...
Pluralformen wird in \REF{ex:kcpregel} gegeben.
...
\subsubsection{K}
Der Fall der recht späten alemannischen\il{Oberdeutsch!Alemannisch} Handschrift
...
Alemannischen\il{Oberdeutsch!Alemannisch} ab der ersten Hälfte des

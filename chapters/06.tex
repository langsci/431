...
häufig auch eine Form ohne Flexion steht
...
\ex \label{ex:adjbaselu}
	...
	\ex \label{ex:adjbaselu_1}
		\gll fur Minv kint Walthern vn̄ hennrichen vn̄ R\sscr{v}{o}dolfen \\
...
\ex \label{ex:adjzueru}
	...
	\ex \label{ex:adjzueru_1}
		\gll min elichú huſvro\sscr{w}{v}e \\
...
\ex \label{ex:adjzuer0}
	...
	\ex \label{ex:adjzuer0_1}
		\gll ſo ſvln min erbin · diz {vol f\sscr{v}{o}rin.} \\
...
\lit{\sscrit{v}{i}}). Daneben sind wenige flexionslose Belege in Positionen des Paradigmas
...
\ex \label{ex:adjkonstregel}
	...
	\ex \label{ex:adjkonstregel_1}
		\gll Huc · C\sscr{v}{o}nrade · \sscr{v}{o}lrich · vn̄ Johanſ mine ſv̓ne \\
...
\ex \label{ex:adjulm}
	...
	\ex \label{ex:adjulm_2}
		\gll mine vorginanten fr\sscr{o}{e}wen von Sovelingen \\
...
ist für Augsburg selbst hauptsächlich \lit{i\sscrit{u}{e}} neben einfachem \lit{iu}
...
\ex \label{ex:adjaugs}
	...
	\ex \label{ex:adjaugs_3}
		\gll Ane mini\sscr{v}{e} Manlehen \\
...
\ex \label{ex:adjsalzbg}
	...
	\ex \label{ex:adjsalzbg_3}
		\gll dev vorgenantev g\sscr{v}{o}t \\
...
\ex \label{ex:kca1regel}
	...
	\ex \label{ex:kca1regel_1}
		\gll und ſuln din g\sscr{u}{o}te fríunt ſin. \\
...
\ex \label{ex:kchregel}
	...
	\ex \label{ex:kchregel_1}
		\gll Owi wie g\sscr{u}{o}te knechte ſie waren. \\
	...
	\ex \label{ex:kchregel_2}
		\gll Vil g\sscr{u}{o}te werc er worchte. \\
...
\ex \label{ex:kcpregel}
	...
	\ex \label{ex:kcpregel_1}
		\gll ir ſit vil g\sscr{u}{o}te knechte. \\
	...
	\ex \label{ex:kcpregel_2}
		\gll dv fordereſ z\sscr{v}{o} mir groze dinc. \\
...
\ex \label{ex:kcc1regel}
	...
	\ex \label{ex:kcc1regel_1}
		\gll Biterner warn g\sscr{u}{e}t chnechte. \\
	...
	\ex \label{ex:kcc1regel_3}
		\gll g\sscr{v}{e}tev werch er worcht. \\
...
\ex \label{ex:kcc1akkpln0}
	...
	\ex \label{ex:kcc1akkpln0_1}
		\gll got hat gr\sscr{o}{e}z wunder durch dich getan. \\
	...
	\ex \label{ex:kcc1akkpln0_2}
		\gll got hat michel w\sscr{o}{v}nder durch dich getan. \\
...
\ex \label{ex:kckregel}
	...
	\sn \gll Die alte herren w\sscr{a}{e}ren \\
...
\ex	\begin{xlist}
	...
	\sn \gll Gr\sscr{o}{e}zu̍ wunder {m\sscr{a}{e}nig ualt} \\
...
\ex \label{ex:groziuwunder}
	...
	\ex \label{ex:groziuwunder_2}
		...
		\gll So gr\sscr{o}{e}ziv zaichen tæt \\
			so groß-\textsc{acc.pl.\NeutI.st} Wunder täte \\

...
ungefähr zwischen 1,5 und 3\,\%; sie finden in den Urkunden also eher selten
Verwendung. Auffällig häufig kommen diese Wortformen als Attribute von
Präpositionalobjekten in Rechtsformeln vor \autocites[\ref{ex:adjprepobj};
vgl.][30]{becker2016}.
...
34\,\% für die erste Hälfte des 14.~Jahrhunderts; Schwäbisch\il{Schwäbisch} wird
nicht gesondert verzeichnet. Bei den Pluralbelegen in der Stichprobe aus
...
auf Hiatusvermeidung\is{Hiatus} zurückgeführt werden kann.

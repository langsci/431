...
sondiert wird, ob an bestimmten wichtigen oberdeutschen\il{Oberdeutsch}
...
Paradigma der starken Adjektivflexion, wie es allgemein für das
Oberdeutsche\il{Oberdeutsch} zu mittelhochdeutscher\il{Mittelhochdeutsch} Zeit
angesetzt wird, wird in
\tabref{tab:adjparadgmstr_pr}--\ref{tab:adjparadgmstr_nm} mit seinen
...
\tabref{tab:adjparadgmstr_pr}--\ref{tab:adjparadgmstr_nm} angegeben.
...
Augsburgs im Übergangsgebiet vom Schwäbischen zum
Bairischen\il{Bairisch} wurden dabei außer Acht gelassen, zumal
hier nicht phonologische, sondern morphosyntaktische Variation angesprochen
wird. Bei der Durchsicht und Klassifizierung der Belege erwies sich dieser
Vorbehalt als unproblematisch.
...
%
Die Auswahl fiel dabei auf die in \tabref{tab:adjsmpwords} aufgelisteten Lemmata.
...
Für das Alemannische\il{Alemannisch} weisen \citet[271, Abb.\
A~47]{ksw2} für die zweite Hälfte des 13.~Jahrhunderts 10\,\% flexionslose
Formen bei vorangestellten Adjektiven in Positionen mit regulärem
\norm{e}-Flexiv aus, 34\,\% für die erste Hälfte des 14.~Jahrhunderts;
Schwäbisch wird nicht gesondert verzeichnet. Auffällig bei den Plural-Belegen
in der hier vorgenommenen Stichprobe aus Urkunden des \CAO{} ist, dass
...
übergangen. Die Tabelle im \sectref{sec:caoadjquanttab} listet die ausgewerteten
...
außerdem zwei Belege zu \norm{ērbǟre} `ehrenhaft, edel' mit \lit{-i} für den
...
regelmäßigen oberdeutschen\il{Oberdeutsch} Flexionsparadigma mit \norm{-iu} zu
...
der Teiluntersuchuchung in \sectref{sec:caoalemschwa} zur Grafie von mhd.
...
Daneben ist die Häufung von Belegen ohne overte Markierung im Nom./Akk.\ Pl.\
M.\ auffällig: 3 Belegen mit \norm{-e} stehen 9 ohne Flexionsendung gegenüber.
Bei diesen unflektierten Belegen handelt es sich sämtlich um Vorkommen des
Possessivpronomens \norm{mīn} `mein' wie in
...
diphthonigiert als \lit{eu} repräsentiert. Die Schwa-Apokope
...
und Feminina zu finden. Diese stehen jeweils mit Apokope \REF{ex:adjwienapo}.
Für den Akk.\ Sg.\ F.\ fanden sich die Formen in \REF{ex:adjwienakksgf}.
...
Flexionsschema passt \REF{ex:adjwienakksgf_4}. Auch hier muss wohl eine
Ausweitung der Neutrumsform ins Femininum angenommen werden, sodass in dieser
...
Ausnahme bildet Straßburg, wo in Positionen mit regelmäßiger \norm{iu}-Form in
...
\tabref{tab:adjcaoovw} fasst die oben diskutierten Ergebnisse der Auswertung
noch einmal zusammen. Da \norm{mīn}-Belege im Nom.\ Sg.~F.\ nicht
aussagekräftig sind, wurden sie für diese Stelle des Paradigmas nicht gezählt.

Die Grafietypen pro Handschrift und Stelle im Paradigma sind in
\tabref{tab:adjcaoovw} nach Häufigkeit ihres Auftretens in der Stichprobe
...
Sg.~F.\ und Nom./Akk.\ Pl.~N.\ im oberdeutschen\il{Oberdeutsch} Paradigma
regelmäßig mit einer Form vom Typ \norm{-iu} zu rechnen. Die letzte Spalte der
Tabelle zeigt eine Bewertung zur Existenz einer systematischen Unterscheidung
zwischen \norm{e}- und \norm{iu}-haltigen Formen am jeweiligen Bezugsort an.
Ein Haken (\chk) bedeutet, dass diese vorliegt, ein eingeklammerter Haken, dass
die Unterscheidung sich nicht immer deutlich äußert.
...
jeder vierte Beleg ausgewertet. Hierzu wurden Kasus, Genus und Numerus sowie
der Deklinationstyp (stark/schwach/prädikativ) und die Stellung
...
\norm{diu hėiligen} `die Heiligen' oder appositiv nachgestellte Attribute wie
in \norm{Sylvester der guete} `Sylvester, der gute' wurden nicht in die Analyse
einbezogen.
...
\norm{grōȥ} `groß' wurde als Ausnahme gewertet \REF{ex:kca1akkplne}.
...
Ostoberdeutschen\il{Ostoberdeutsch} bis in die zweite Hälfte des
...
auch im Sg.~F.\ \autocite[vgl.][181--184]{ksw2}. Der Genus\-unterschied im
Plural ist also aufgehoben, wie in \REF{ex:kchregel} illustriert. Belege für
den Plural Femininum sind in der Stichprobe keine vorhanden.
...
sich keine Belege für Feminina im Plural finden, obwohl aufgrund der
vergleichsweise geringeren Belegmenge sogar jeder zweite Beleg ausgewertet
wurde. Je ein Beispiel für die anderen beiden Pluralformen wird in
\REF{ex:kcpregel} gegeben.
...
\REF{ex:kcc1akkpln0_2}, mit Ausnahme von VB, wo das Adjektiv ausfällt.
...
Femininum liegen keine Belege vor. Da diese schwäbische Handschrift auf die
Mitte des 15.~Jahrhunderts datiert wird \autocite[32]{wolf:kckat}, ist davon
auszugehen, dass der Grund dafür der vollständige Vollzug der
Nebensilbenabschwächung ist. Diese setzt sich im
Alemannischen\il{Alemannisch} ab der ersten Hälfte des
14.~Jahrhunderts durch \autocites(Schwäbisch wird nicht gesondert
ausgewiesen)[vgl.][267, Abb.~A~69]{ksw2}.
...
Opposition nicht von Belang. Nimmt man \tabref{tab:beidevar} hinzu, fallen bei

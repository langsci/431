...
\crefrange{fig:adjparadgmstr_pr}{fig:adjparadgmstr_nm} mit seinen Synkretismen
aufgeführt.
...
\end{tabular}
\caption
	{Nominal-starke Adjektivflexion in oberdeutschen Schreibdialekten des
	Mittelhochdeutschen nach \citet[182, Abb. A~3]{ksw2}}
\label{fig:adjparadgmstr_nm}
\end{figure}

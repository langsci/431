...
einzelnen Lemmata aus der \isi{Datenbank} extrahiert, die der Tagger von
...
die Analyse der starken Adjektivdeklination dar. Zusätzlich wurden die Adjektive
\norm{hėilic} `heilig' (ca.~1.816 Belege), \norm{alt} `alt' (ca.~1.201 Belege)
und \norm{arm} `arm' (ca.~640 Belege) ausgewertet. Diese erscheinen in der \KC{}
fast ausschließlich mit Bezug auf Männer und in definiten\is{Definitheit}, also

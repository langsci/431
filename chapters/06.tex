...
\ex \label{ex:kcb1regel}
	...
	\ex \label{ex:kcb1regel_1}
		...
		\begin{taggedline}{\parencites[\pno~23\vb, 23]B1[vgl.][8477]{schroeder1895}}
	...
	\ex \label{ex:kcb1regel_2}
		...
		\begin{taggedline}{\parencites[\pno~31\vb, 15]B1[vgl.][11413]{schroeder1895}}
		\trans `dadurch kam sie später in große Nöte'
		\end{taggedline}
	...
	\ex \label{ex:kcb1regel_3}
		\gll zwai grozeu her ſínt ſament chomen \\
			zwei[\NeutI] groß-\textsc{nom.pl.\NeutI.st} Heer sind zusammen
				gekommen \\
		\begin{taggedline}{\parencites[\pno~11\rc, 2]B1[zu][3535]{schroeder1895}}
...
\ex \label{ex:kcvbregel}
	...
	\sn \gll Noch alſo groze magen \\
		...
		\begin{taggedline}{\parencites[\pno~95\rb, 5--7]VB[vgl.][14035--14036]{schroeder1895}}
	...
	\ex \label{ex:kcvbregel_2}
		...
		\begin{taggedline}{\parencites[\pno~92\va, 22]VB[zu][13514]{schroeder1895}}
	...
	\ex \label{ex:kcvbregel_3}
		...
		\begin{taggedline}{\parencites[\pno~24\va, 23]VB[vgl.][4944]{schroeder1895}}
...
\ex \label{ex:kcvbaccplne}
	...
	\sn \gll Vil heiden er becherte \\
		...
		\begin{taggedline}{\parencites[\pno~100\vb, 13--15]VB[vgl.][40\va,
		10--12]B1}
...
\ex \label{ex:kcc1regel}
	...
	\ex \label{ex:kcc1regel_1}
		...
		\begin{taggedline}{\parencites[\pno~23\vb, 33]C1[vgl.][4383]{schroeder1895}}
	...
	\ex \label{ex:kcc1regel_2}
		...
		\begin{taggedline}{\parencites[\pno~7\ra, 18]C1[vgl.][1286]{schroeder1895}}
	...
	\ex \label{ex:kcc1regel_3}
		...
		\begin{taggedline}{\parencites[\pno~68\vb, 2]C1[vgl.][13072]{schroeder1895}}
...
\ex \label{ex:kckregel}
	...
	\sn \gll Die alte herren waͤren \\
		...
		\begin{taggedline}{\parencites[\pno~51\ra, 37]K[vgl.][8477]{schroeder1895}}
	...
	\ex \label{ex:kckregel_2}
		...
		\begin{taggedline}{\parencites[\pno~8\rb, 25]K[vgl.][1286]{schroeder1895}}
		\trans `er beging so große Maßlosigkeiten'
		\end{taggedline}
	\end{xlist}
\end{exe}
...
\ex \label{ex:kczregel}
	...
	\ex \label{ex:kczregel_1}
		...
		\begin{taggedline}{\parencites[\pno~233\ra, 17]Z[zu][11620]{schroeder1895}}
	...
	\ex \label{ex:kczregel_2}
		...
		\begin{taggedline}{\parencites[\pno~61\va, 1]Z[vgl.][3089]{schroeder1895}}
	...
	\ex \label{ex:kczregel_3}
		...
		\begin{taggedline}{\parencites[\pno~135\ra, 9]Z[vgl.][6849]{schroeder1895}}

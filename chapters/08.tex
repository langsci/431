...
Das Beispiel in \cref{ex:beid2subst} und das Schema in \figref{fig:beid2subst}
...
\cref{ex:beidplsubst} angeführte und in \figref{fig:beidplsubst} illustrierte
...
in \cref{ex:beidanactrl} und \figref{fig:beidanactrl} illustriert.%
%
...
\norm{bėide} als Target wie in \cref{ex:nplsibeide} und \figref{fig:nplsibeide}
...
\tabref{tab:sieprn} aufgeführten Textzeugen ausgezählt. Dieses Vorgehen

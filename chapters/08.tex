...
zwischen dem letzten Viertel des 12.~Jahrhunderts und dem Ende des
...
zeitlich den Urkunden\is{Urkunde} des \CAO{} nahe.
...
zwei eindeutig männliche \isi{Erstcontroller} in B1. Daneben lagen zwei
parallele Belege zur Kombination der beiden belebten\is{Animata} Neutra
\norm{wīp} `Frau' und \norm{kindelīn} `Kindlein' vor, in denen der Beleg aus B1
...
Kategorien wie zuvor zusammenzufassen. Die Verteilung der Belege wird in
...
die Form der Konjunktion auswirken, ist die Verteilung der Formen bei manchen
der Handschriften in \tabref{tab:kcbeidefuncvar} auffällig. In den untersuchten

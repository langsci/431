...
unbelebt\is{Belebtheit} einnimmt (vgl.~\sectref{sec:gendsex} zur Annotation von
\isi{Genus} bei Inanimata).
...
sich um unbelebte Maskulina. Es scheint im Kontext\is{Pragmatik} der Stelle

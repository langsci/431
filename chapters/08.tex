...
Controllern steht bei der Kombination von feminin-weiblichem \lit{muͦter}
`Mutter' mit pronominalem \lit{dv} (gemeint ist der \lit{chûnig} `König' in B1
(23rc,5) die formal neutrale Form \lit{beideu} \cref{ex:mutterdu2}. Dies

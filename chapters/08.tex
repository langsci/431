...
eingeordnet. Danach folgt die Untersuchung der
Verteilung\is{Distribution!morphologische} der Formen des Quantors \norm{bėide}
in Bezug auf die unterschiedlichen morphosyntaktischen Kontexte, in denen er
belegt ist. Zunächst sollen diejenigen Kontexte beleuchtet werden, in denen
\norm{bėide} von Substantiven sowie Pronomina abhängt und deren
Personenmerkmale\is{Personenmerkmal} durch Kongruenz reflektiert. In einem

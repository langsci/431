...
werden kann, dass sich \lit{baidiu} an der zuvor zitierten Stelle tatsächlich
auf Karl und den Papst bezieht.
...
formalen Neutra, zum anderen als Resolutionsform, insofern \feat{weiblich} und
\feat{unbekannt} keine Schnittmenge besitzen
...
Die \norm{iu}-Form des Quantors bei kombiniertem männlichem Bezug ist
...
(eine Parallelstelle\is{Paralleltext} zu C1:~75rb,3--4, siehe
auch~\sectref{phsec:babstimbaideu} und
\sectref{phsec:baideuwarn}) mit einer formal neutralen Form in Bezug auf zwei
maskulin-männ\-liche Referenten im vorhergehenden (Teil-)Satz liegt in K vor
\REF{ex:baideuwarn3}. Die Form \lit{baidu̍} im Nebensatz bezieht sich hier
wohl auf \lit{babſt} \wdef{Papst} und \lit{ím} \wdef{ihm} (=~\lit{Karle}) im
...
\sectref{ex:richtherriu}). In beiden Fällen stehen semantisch männliche
...
ebenfalls großteils regelmäßig verhalten. In der \isi{Domäne} \q{gleiches
...
Resolution} zu rechnen, doch steht trotz allem eine Form vom Typ \norm{bėide}
statt \norm{bėidiu}.
...
auch Closest Conjunct Agreement\is{Closest Conjunct Agreement}
...
verschiedenem belebtem\is{Animata} Geschlecht beziehungsweise bei

...
Kombination der beiden belebten Neutra \norm{wīp} `Frau' und \norm{kindelīn}
`Kindlein' vor, in denen der Beleg aus B1 ebenfalls den Typ \norm{bėidiu}
enthält, VB dagegen den Typ \norm{bėide}.
...
Konjunkten mit gleichem und unterschiedlichem semantischen oder grammatischen
...
uneindeutigen\is{Ambiguität} belebten Konjunkt noch mindestens ein weiterer
...
unbelebte Targets tendenziell anders verhalten als belebte, kann nicht
ausgemacht werden, da für unbelebte \norm{bėide}-Targets nur ein einziger Beleg
vorhanden ist. Dass mit belebtem Bezug \norm{bėidiu} in sechs Fällen vorkommt,
...
belebten Geschlecht beziehungsweise bei unbelebtem Bezug auf.

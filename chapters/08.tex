...
auf zwei eindeutig männliche Erstcontroller in B1. Daneben lagen zwei parallele
Belege zur Kombination der beiden belebten\is{Animata} Neutra \norm{wīp} `Frau'
und \norm{kindelīn} `Kindlein' vor, in denen der Beleg aus B1 ebenfalls den Typ
...
Ausnahme\is{Ausnahme}, nur bei Erstcontrollern mit ungleichem Geschlecht oder
Genus belegt.
...
\end{tikzpicture}
\caption{Hypothetischer indirekter Bezug eines Targets auf einen einzelnen \q{Erstcontroller} über ein prädikatives Adjektiv\is{Adjektiv!prädikativ}}
\label{fig:recquery}
\end{figure}
...
als sein Erstcontroller. Zuletzt sind die Adjektive in

...
ausgeschlossen werden kann. Es lässt sich spekulieren, ob \lit{beideu} mit
Bezug auf die zwei Männer möglicherweise unter Einfluss des \lit{beideu} im
vorhergehenden Vers gesetzt wurde.
...
Belege für \norm{bėide}, deren Kongruenzdomäne nicht eindeutig zugeordnet
werden kann und die deshalb gemäß \citet[623]{ksw2} der Domäne \q{gleiches
...
hinaus liegt für die Kombination mit einem geschlechtlich uneindeutigen
belebten Konjunkt noch mindestens ein weiterer Beleg für \norm{bėidiu} vor
\REF{ex:datextra}.
...
ausgelassen. Darüber hinaus kommt \norm{bėidiu naht unde tac} `sowohl Nacht als
auch Tag' mehrfach als temporales Adverbial\is{Adverbial} vor, bei dem die

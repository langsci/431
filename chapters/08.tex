...
Übereinstimmung\is{Kongruenz!formale} mit seinem Controller die neutrale Form.
...
der NP\is{Nominalphrase} ebenfalls formale Kongruenz\is{Kongruenz!formale} auf,
doch liegen zwei Belege für neutrales \norm{bėidiu} bei eindeutig
...
Kontext auch in der \KC{} semantische Kongruenz\is{Kongruenz!semantische} die
...
in einer Neutralisierungsposition befindet, nicht in die Auszählung einbezogen
...
unbelebten\is{Inanimata} zu \norm{bėidiu} vorliegt. Dies deckt
sich\is{Validierung} jedoch nicht mit der wesentlich älteren Handschrift A1, in

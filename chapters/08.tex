...
\norm{kindelīn} \wdef{Kindlein} (V.~910--932; \cite[98]{schroeder1895}). Das
...
\lit{ſchatz vnd gewín} \wdef{Schatz und Gewinn}, auch wenn letzteres nicht
...
Da die \KC{}-Hand\-schrif\-ten in der vorliegenden Form nicht morphologisch
...
pronominalem \lit{dv} \wdef{du} die formal neutrale Form \lit{beideu}. Dies
...
\lit{baidu̍} im Nebensatz bezieht sich hier wohl auf \lit{babſt} \wdef{Papst}
und \lit{ím} \wdef{ihm} (=~\lit{Karle}) im Hauptsatz und damit auf zwei Männer,
zeigt aber die formal neutrale Form (vgl.~\sectref{phsec:babstimbaideu} zur
...
Controller -- \lit{rihtær} \wdef{Richter} und \lit{herren} \wdef{Herren} -- mit
...
untersuchten bairischen\il{Bairisch} Handschriften A1, M, B1, VB und C1 sowie
...
\norm{wīp} um ein starkes Neutrum der \fw{a}-Deklination \autocites[254,
305]{braune2023}[353--354, 584]{kroonen2013}. Darüber hinaus sind gerade
...
\lit{wip} \wdef{Frau (\NeutF)} und \lit{man} \wdef{Mann (\MascM)} steht die Form
\lit{baide}.
...
\ex \begin{xlist}
	...
	\sn \gll Beidív hoͤbſh vnd gemeit \\
		...
		\trans \wdef{und viele herrliche, sowohl höfische als auch liebliche
			Edelfrauen}
			(%
				VB:~21va,21--22; zu
				\KC:~V.~4351--4352;
...
Kongruenz aufweisen soll, müsste sie ihrerseits mit den beiden Adjektiven in
den von ihnen referenzierten Personenmerkmalen\is{Personenmerkmal}
übereinstimmen.

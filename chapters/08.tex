...
\caption%
	{Anzahl der Belege für mittelhochdeutsch \norm{bėide} pro Sprachlandschaft
	und Handschrift. Maßgeblich ist die Annotation\is{Annotation} der Punkte,
	nicht ihre grobe Platzierung auf der Karte (Hintergrundkarte:
...
\lit{warn} `Kinder' zu mittelhochdeutsch \norm{barn} `Kind, Sohn; Jüngling,
Held (?)' \autocites[s.\,v.\fw{barn}]{mwb1}[vgl.~auch][53]{kroonen2013} bezieht
sich hier metaphorisch auf Karl den Großen und Papst Leo~III., die vom
...
stehen dabei jedoch ebenfalls im Reim\is{Versende} und damit in einer
...
`beide' kommt in A1 neben \lit{bediu}, \lit{bæde} und \lit{bædiu} vor -- anders
...
nebeneinander auftreten. Allerdings findet sich im \CAO{} die Grafie \orth{ie},
\orth{iͤ} für mittelhochdeutsch \norm{ī} im Bairischen\il{Bairisch} allgemein
...
neben belegtem \lit{du̍} als Vertreter von

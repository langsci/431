...
\sectref{sec:adjdeclkc} zur Adjektivdeklination in \KC{}-Handschriften). In der
Tabelle entfällt textbedingt der größte Anteil auf die Kombination von zwei
maskulin-männ\-lichen Referenten ($\textsc{3sg.\MascM + 3sg.\MascM}$).
...
aber nicht. Nichtsdestoweniger koindizieren\is{Koindizierung}
Adjektive\is{Adjektiv!attributiv} und Verben diejenigen
Substantive\is{Substantiv} oder Pronomina, auf die sie sich beziehen, sodass
\norm{bėide} zumindest theoretisch indirekt über die Konjunkte eine Affinität
zu den Personenmerkmalen\is{Personenmerkmal} der Controller der Konjunkte
zeigen könnte, wie anhand von \REF{ex:recquery} in
...
Satzes bezieht. Auch in diesem Fall ist der Bezug dem Kontext\is{Pragmatik}
nach maskulin-männlich, insofern es sich bei den \lit{hende\textins{n}} um
Soldaten handelt. Das Adjektiv steht in einem anderen Satzglied als sein
\isi{Erstcontroller}. Zuletzt sind die Adjektive in \REF{ex:konjadjvvbeidiu_6}
als Apposition\is{Apposition} zu ihrem Controller aufzufassen. Syntaktisch
...
hier prädikativ und stehen in einem \isi{Relativsatz}, damit formal in einem

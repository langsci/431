...
(dialekt-)geografische\is{Dialektgeografie} Bezugsgröße angegeben. Die
Platzierung der Handschriften auf der Karte folgt weitestgehend den Angaben des
...
neuhochdeutscher\il{Neuhochdeutsch} Diphthongierung\is{neuhochdeutsche
...
und Semantik aufweisen.\is{Ausnahme}
...
abgesehen von einer Ausnahme\is{Ausnahme}, nur bei
Erstcontrollern\is{Erstcontroller} mit ungleichem Geschlecht oder \isi{Genus}
belegt.
...
Belegsituation für die \isi{Domäne} \q{gleiches Satzglied} nicht einschätzen.
Die Targets mit \isi{Distanzstellung} in der \isi{Domäne} \q{gleicher
...
belebten\is{Animata} Konjunkte mit gemischtem \isi{Genus} beziehungsweise
\isi{Sexus} zehn Belege mit \norm{bėidiu} gegenüber sieben Belegen mit
\norm{bėide} vor.
...
gleichen Kontext variiert, ist nicht davon auszugehen, dass \isi{Genus} oder

...
Ferner beobachtet \citeauthor{schneider1987} abweichend von den Angaben im
...
\norm{quam} `kam' neben bairischem\il{Bairisch} \norm{chom} enthält. Obwohl sie
dem Schreiber Bemühungen zur Vermeidung von Dialektismen attestiert, erwägt sie
als Entstehungsort den südböhmischen\il{Böhmisch} oder

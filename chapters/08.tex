...
Darüber hinaus merkt \citet{klein1988} zur Handschrift H an, sie möge
...
die Beispiele in \REF{ex:k_beider} zeigen, sodass davon ausgegangen werden
kann, dass sich \lit{baidiu} an dieser Stelle tatsächlich auf Karl und den
Papst bezieht.
...
\ex \label{ex:k_beider}
	...
	\ex \label{ex:k_beider_1}
		\gll Clementem daz kíndelin \\
			Clēmēns-\textsc{acc.sg.\MascM} das Kindlein \\
	\sn	\gll V̍nſer baider kínt \\
			unser beide-\textsc{gen.pl.st} Kind \\
	\sn \gll Bevilch ich allen die hie ſínt \\
			befehle ich allen die hier sind \\
		\trans `Clemens das Kindlein, unser beider Kind, befehle ich allen an,
			die hier sind.' (%
				K:~9rb,24--26; vgl.
				C1:~8vb,26--28;
				% VC:~6va,12--14;
				Z:~31va,2--4; abweichend
				A1:~7va,2--4;
				H:~9va,41--43;
				P:~15va,14--15;
				\KC:~V.~1637--1639;
...
\tabref{tab:simpnomctrla} wurde dieser Beleg mit \textsc{n\SA} gekennzeichnet,
...
Kombination zweier maskulin-männlicher Referenten ($\textsc{3sg.\MascM +
...
Säugling handeln.%
%
	\footnote{Zu Besonderheiten beim Epikoinon \fw{Kind} siehe
		\sectref{phsec:epikoina}.}
%
Die beiden Belegstellen werden in \REF{ex:wipkindelin} wiedergegeben.
...
noch der Wortformen\-abstand zwischen Contoller und Target einen auffälligen
...
\begin{table}
\setlength{\tabcolsep}{4pt}
\caption{Form nach Distanz von kombinierten nominalen
Controllern}
\begin{tabular}{
	l
...
Beleg für \norm{bėidiu} vor \REF{ex:datextra_1}. Weiterhin findet sich noch
einen Beleg für \norm{bėide}, der dem Kontext nach im Dativ stehen dürfte,
allerdings ist auch der Sexus seiner Konjunkte nicht eindeutig
\REF{ex:datextra_2}.
...
der Controller der Konjunkte zeigen könnte, wie anhand von \REF{ex:recquery}
in \figref{fig:recquery} schematisch dargestellt.
...
\norm{unde} \textsc{adjektiv/verb}}, kein formales oder semantisches Kriterium

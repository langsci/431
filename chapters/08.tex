...
zweiten Teil wird nach möglichen Effekten der Distanz zwischen \isi{Controller}
und Target gefragt. Der dritte Abschnitt schließt dieses Kapitel mit einer
...
Einzelfälle, Ausnahmen\is{Ausnahme} und Zweifelsfälle\is{Ambiguität} werden
exemplarisch diskutiert. Da die \tit{Kaiserchronik} (\KC{}) in einer Vielzahl
von Handschriften überliefert ist, werden dabei, wenn möglich, relevante
...
neben belegtem \lit{du̍} als Vertreter von genusindifferentem \norm{siu}
zumindest denkbar.
...
untersuchten Handschriften nach der Reihenfolge ihrer ungefähren
...
handelt es sich historisch um ein Wurzelnomen, bei \norm{wīp} um ein starkes
Neutrum der \fw{a}-Deklination \autocites[250, 294--295]{braune2018}[353--354,
...
werden kann. Trotz allem liegen in der Gruppe der belebten\is{Animata}
Konjunkte mit gemischtem Genus beziehungsweise Sexus zehn Belege mit
...
männlich denotiertes Maskulinum vor. Da es sich bei dessen Kongruenztargets um
Verben handelt, steht die Konjunktion im gleichen (Teil-)Satz wie die Verben.
In \REF{ex:konjadjvvbeidiu_4} steht ein koprädikatives
Adjektiv\is{Adjektiv!prädikativ}, das sich auf das Objekt des Satzes bezieht.
Auch in diesem Fall ist der Bezug dem Kontext nach maskulin-männlich, insofern
es sich bei den \lit{hende\textins{n}} um Soldaten handelt. Das
Adjektiv\is{Adjektiv!prädikativ} steht in einem anderen Satzglied als sein
Erstcontroller. Zuletzt sind die Adjektive in \REF{ex:konjadjvvbeidiu_6} als
Apposition\is{Apposition} zu ihrem Controller aufzufassen. Syntaktisch befinden
sie sich im gleichen Satzglied.

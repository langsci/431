...
bairische\il{Oberdeutsch!Bairisch} Sprachgebiet heraus. Dies ist dem Umstand
geschuldet, dass die \KC{} vor allem im
bairisch-österreichischen\il{Oberdeutsch!Bairisch} Raum überliefert ist
\autocite{klein1988}. Dezidiert alemannische\il{Oberdeutsch!Alemannisch}
...
von K (mittelalemannisch\il{Oberdeutsch!Alemannisch}) nur unter den Fragmenten
...
\norm{quam} `kam' neben bairischem\il{Oberdeutsch!Bairisch} \norm{chom}
...
ostbairisch\il{Oberdeutsch!Bairisch}-oberpfälzischen Raum
...
dem bairischen\il{Oberdeutsch!Bairisch} Sprachraum zugeordnet werden
\autocites{wolf:kckat}[266--276]{fleischer2019}.%
%
	\footnote{Auch wenn \citet[40--41]{schneider1987} insgesamt zu dem Schluss
		kommt, dass der \KC{}-Text in A1 bairische\il{Oberdeutsch!Bairisch}
...
bairischen\il{Oberdeutsch!Bairisch} Schreib\-kontext passen.

\citet[396--397]{ksw2} führen \norm{seu} (mit
neuhochdeutscher\il{Neuhochdeutsch} Diphthongierung) als ver\-all\-gemeinerte
Form des Nom./Akk.\ Pl.\ im Bairischen\il{Oberdeutsch!Bairisch} an und
mutmaßen, dass diese Form in der Umgebung des Habsburgers Albrecht~I.\
(1255--1308) aus dem Alemannischen\il{Oberdeutsch!Alemannisch} entlehnt worden
...
Bairischen\il{Oberdeutsch!Bairisch} allgemein
...
bairischen\il{Oberdeutsch!Bairisch} Handschriften A1, M, B1, VB und C1 sowie in
der mittelalemannischen\il{Oberdeutsch!Alemannisch} Handschrift K deutet sich
...
bairischen\il{Oberdeutsch!Bairisch} Handschriften bei der Konjunktion noch

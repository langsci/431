...
Da der Wortformenabstand\is{Distanz!absolute} und der syntaktische
...
Verteilung der Belege wird in \tabref{tab:codistp} aufgeführt.
...
Abstand~--,\is{Distanz!absolute} deren Quantor eine Form des Typs \norm{bėide}
...
Distanz\is{Distanz!absolute} derjenigen Belege, bei denen der Quantor
...
Distanzstellung in der Domäne \q{gleicher Teilsatz}\is{Distanz!syntaktische}
verteilen sich insgesamt ähnlich wie im \CAO{} (vgl.~\tabref{tab:caoanadist}),
insofern ist zu vermuten, dass in diesem Kontext auch in der \KC{} semantische
...
Wortformenabstands\is{Distanz!absolute} in allen Fällen ähnlich. Auch

...
\ex\label{ex:mutterdu}
	\gll Z\sscr{v}{o} dem chûnig ſprach er ſan \\
		zu dem König[\textsc{dat.sg.\MascM}] sprach er sodann \\
	\textelp{}
\sn \gll Dein m\sscr{u}{o}ter vnd dv \\
		dein Mutter[\textsc{nom.sg.\FemF}] und \textsc{2sg\subM.nom} \\
\sn \gll Schv̂ln beideu chv̂men {dar z\sscr{v}{o}} \\
...
\sn \gll W\sscr{a}{e}ren baidu̍ worden bar \\
...
\ex \label{ex:k_beider}
	...
	% \ex \label{ex:k_beider_2}
		...
		\gll H\sscr{u}{o}b ſich vrlu̍g vnd ſtrit \\
...
\ex \label{ex:wipkindelin}
	...
	\ex \label{ex:wipkindelin_1}
		\gll Sit wír nv m\sscr{v}{e}zzen verderben \\
	...
	\ex \label{ex:wipkindelin_2}
		\gll Seit wir m\sscr{u}{e}zzen verderben. \\
...
wir baidev verl\sscrit{o}{e}rn} \wdef{dann wären wir beide verloren} (C1:~60rb,44--60va,3).
...
\ex \label{ex:vbsisie}
	...
	\sn \gll Vnd hiez ſie manen aller tr\sscr{ı}{v}wen \\
...
bei der Kombination von feminin-weiblichem \lit{m\sscrit{u}{o}ter} \wdef{Mutter} mit
...
\ex \label{ex:mutterdu2}
	\gll Dein m\sscr{u}{o}ter vnd dv \\
		dein Mutter[\textsc{nom.sg.\FemF}] und \textsc{2sg\subM.nom} \\
\sn \gll Schv̂ln beideu chv̂men {dar z\sscr{v}{o}} \\
		sollen beide-\textsc{nom.pl.\NeutMF.st} kommen dahin \\
...
\ex \label{ex:baideuwarn3}
	...
	\gll W\sscr{a}{e}ren baidu̍ worden bar {/} \\
...
\ex \label{ex:combgenddist1}
	...
	\sn \gll deines br\sscr{u}{o}der weip. \\
	         deines Bruders Frau[\NeutF] \\
	\sn	\gll vraiſchet das {dhaín leip.} \\
		     erführe das niemand \\
	\sn \gll so wærn wir baidev verl\sscr{o}{e}rn. \\
...
\ex \label{ex:combgenddist2}
	...
	\sn \gll Si warn zegot biderb vnd frumic \\
			\textsc{3pl\subM.nom} waren {zu=Gott} brav und tüchtig \\
	\sn \gll Zegot ſt\sscr{u}{o}nt allr ir geſín \\
			{zu=Gott} stand aller ihr Sinnen \\
...
\ex \label{ex:konjmixbeide2}
	...
	% \sn \gll Ez enm\sscr{v}{e}ſe gar verbrínnen \\
...
\ex \label{ex:konjbeidirreginan}
	...
	\ex \gll beide geu\sscr{o}{v}re vnt ere \\
...
wo das Neutrum \lit{geu\sscrit{o}{v}re} \wdef{Nutzen} und das Femininum \lit{ere}
...
\REF{ex:kczbeidenunde_1} weicht hier ab und formuliert \lit{\textins{da}rz\sscrit{u}{o} man
...
\ex \begin{xlist}
	\ex\label{ex:konjattradj}
		\gll Vnd maníge ſtolze fr\sscr{o}{v}wen \\
			und viele herrliche Frau-\textsc{nom.pl.\FemF} \\%
	\sn \gll Beidív h\sscr{o}{e}bſh vnd gemeit \\
...
\ex \label{ex:konjadjvvbeidiu}
	...
	\ex \label{ex:konjadjvvbeidiu_2} % kumulierte Wortentfernung: 4/8
		\gll Daz der kvnich zelande f\sscr{v}{o}re \\
			dass der König[\textsc{nom.sg.\MascM}] zu=Lande
			fahren[\textsc{3sg\subM.sbjv.pst}] \\
	\sn \gll Beidiv lobte vnd ſw\sscr{u}{e}re \\
	...
	% "/" eingefügt und manuelle Zeilenwechsel entfernt
		\gll Ovch gelagen dem k\sscr{v}{e}nige {/} \\
			auch lagen dem König \\
...
\ex \label{ex:konjadjvvbeide}
	...
	% \ex \label{ex:konjadjvvbeide_2} % kumulierte Wortentfernung: 2/6
		...
		\gll mer denne {ſiben tuſent} man. {/} \\
			mehr denn siebentausend Mann[\textsc{nom.pl.\MascM}] \\
		\gll baide w\sscr{o}{v}nt. unt erſlagen. \\
	...
	% 	\gll Daz dv dich an die g\sscr{o}{e}t laſt \\
...
\ex \label{ex:syntintvar1}
	\begin{xlist}
	\ex \gll Beideu vr\sscr{u}{o} vnd ſpæt \\
		beide früh und spät \\
	...
	\ex \gll Beideu ſpæt vnde vr\sscr{u}{o} \\
		beide spät und früh \\

...
\caption%
	...
	und Handschrift. Maßgeblich ist die Annotation der Punkte, nicht ihre grobe
	Platzierung auf der Karte (Hintergrundkarte: \cite{wiesinger1983:rede})}
...
Annotation als \isi{Committee Noun} \autocite[211--213]{corbett2006} aufgefasst
...
overter Flexion, die ansonsten in der \isi{Stichprobe} zu B1 für den starken
...
unbelebt\is{Inanimata} einnimmt (vgl.~\sectref{sec:gendsex} zur Annotation von
\isi{Genus} bei \isi{Inanimata}).

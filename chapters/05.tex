...
der \isi{Stichprobe} 291 Urkunden aus 114 Orten vertreten, von denen 256
Urkunden aus 102 Orten für die Auswertung verwendbar waren.
...
der \isi{Stichprobe} enthalten sind, macht den Vergleich zu den Urkunden des
\CAO{} besonders interessant, da dort umgekehrte Mengenverhältnisse vorliegen:
Im \CAO{} stehen 76 Belege mit kombiniertem gemischtgeschlechtlichen Bezug zur
...
\isi{Stichprobe} lediglich vier vor. Davon enthält der einzige Beleg im
...
Adjektivstichprobe\is{Stichprobe} auch in anderen untersuchten Handschriften im
...
der Flexion beim nachgestellten Adjektiv\is{Adjektiv!attributiv} im Reim
feststellen. Die \isi{Endungslosigkeit} von \lit{paid} in \REF{ex:chindpaid_1}

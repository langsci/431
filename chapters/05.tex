...
B-Vergleichshandschrift VB lautet die Zeile \lit{Boͤſen vnd
frvͤmigen} `bösen und tüchtigen', allerdings ohne einleitendes
...
\lit{baidiu guoten unt ubelen} `sowohl guten als auch bösen' nur auf
...
kinde baider} `der beiden Kinder'. Bei Voranstellung des schwach
...
\norm{mvt} `Gesinnung, Stimmung, Geist' gereimt wird. Es ist möglich,
...
\ex \label{ex:neutralpos2}
	...
	\sn \gll da worden ſi baide \sscr{o}{v}ffe erſlagen. \\
	...
	\ex \label{ex:neutralpos2_2}
		\gll Rome vnd Lateran \\
			Rom und Lateran \\
	\sn \gll Wurden ím baid\sscr{u}{ı} vndertan \\
...
Mit Ausnahme der Handschrift K wurden keine alemannischen

...
\fw{*weid-} mit bairischer\il{Oberdeutsch!Bairisch} Verwechslung von \norm{b}
...
erwiesen, da der Text im bairisch-österreichischen\il{Oberdeutsch!Bairisch}
...
bairischen\il{Oberdeutsch!Bairisch} Handschrift B1 zum Urkunden\-material
...
bairischen\il{Oberdeutsch!Bairisch} Urkunden -- anders als in den meisten
...
alemannischem\il{Oberdeutsch!Alemannisch} Schreibdialekt in die Analyse
aufgenommen. Der Vollständigkeit halber seien in \REF{ex:beidkcalem} die
wenigen Belege zu \norm{bėide} aus solchen Fragmenten aufgeführt, die im
\citet{hsc} als spezifisch alemannisch\il{Oberdeutsch!Alemannisch} ausgewiesen

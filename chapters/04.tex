...
Gegen die Frage der \isi{Editionsphilologie} nach der Genese,
\isi{Überlieferung} und Rekonstruktion von Texten ist nichts einzuwenden.
...
größere Interesse an der Materialität der Textüberlieferung\isi{Überlieferung}
...
allerdings ihren Überlieferungsschwerpunkt\is{Überlieferung} im
Ostoberdeutschen\il{Bairisch}, wie die Abbildungen
\ref{fig:kc_geospac_rough_12} bis \ref{fig:kc_geospac_rough_15} deutlich machen
...
dass Dialekt\-mischungen eher die Regel als die Ausnahme\is{Ausnahme}
darstellen. Der Vergleich der Daten aus der Auswertung der \KC{} mit denen der

...
Umweg über das Lateinische\il{Lateinisch} formuliert ist, obgleich integrale
Bestandteile des Urkundenformulars aus der lateinischen\il{Lateinisch}
...
stellt einen diplomatischen Abdruck zur Verfügung. Eine textkritische
Ausgabe,\is{Editionsphilologie} die die Texte der Rezensionen~B und C als
gleichberechtigt neben A behandelt, ist bisher ein \isi{Desiderat}.
...
Vorgänge der dia\-topischen und dia\-chronischen\is{Diachronie} Mikrovarianz zu
beobachten, die im textkritischen\is{Editionsphilologie} Apparat normalen
...
nicht: \isi{Autornähe}. Des Weiteren sind die Handschriften der
...
Auswahl der Informantinnen und Informanten. Diese Komplexitätsreduktion

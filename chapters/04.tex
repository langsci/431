...
sprachgeografische\is{Sprachgeografie} Zuordnungen ausgerichtet. Bei
...
und die allenfalls zusätzlich sprachgeographisch\is{Sprachgeografie} weiter
...
werden, dass durch den Ausstellungsort der geographische\is{Sprachgeografie}
...
geografisch\is{Sprachgeografie} lokalisieren lassen \autocite[16]{schulze2011}.%
%
...
die volkssprachige Beurkundung in diesem Sprachraum\is{Sprachgeografie} früher
als im ostoberdeutschen\il{Bairisch} eingesetzt hat
\autocites[1774]{skala1985}[15]{schulze2011}.

Einen Überblick über die geografische\is{Sprachgeografie} Verteilung der
Belegorte und zuordenbaren Urkunden gibt \figref{fig:cao_urkorte}. Die Karte
stellt die deutschen\il{Neuhochdeutsch} Dialektlandschaften auf dem Stand des
frühen 20.~Jahrhunderts dar, inklusive der Gebiete außerhalb der modernen
...
Sprachraumkonturen\is{Sprachgeografie} keinesfalls vorschnell und unkritisch
...
westoberdeutsche\il{Westmitteldeutsch} Sprachraum\is{Sprachgeografie} zunächst
...
sprachgeografisch\is{Sprachgeografie} orientierte Analysen eine ideale
...
Raumstrukturen\is{Sprachgeografie} zutage treten. Besonders hervorzuheben ist
...
Dialektgeographie\is{Sprachgeografie} des 19.~Jahrhunderts erwiesen hat, in der
...
Dialektgeografische\is{Sprachgeografie} Karten bilden nie die Gesamtheit der

...
\citet[23--33]{boesch1946}, \citet[389]{haacke1955} und
\citet[\RN{29}--\RN{35}]{deboorhaacke1957} geäußerte, für grundlegend gehaltene
Erfordernis der Schrei\-ber\-identifizierung\is{Schreiberidentifizierung} an,
das sich lange Zeit stark hemmend auf die Erforschung des \CAO{} ausgewirkt hat.
% Misstrauen in der älteren Forschung gegenüber einzelnen Urkunden\-texten, vor
% allem solchen mit unbekanntem Schreiber, gründet sich auf die Beobachtung,
% dass der bezeichnete oder indirekt ermittelte Ausstellungsort nicht zwingend
% der Herkunftsort des Schreibers sein muss
...
Auch wenn nicht gewährleistet werden kann, dass sich der Herkunftsort des
Schreibers\is{Schreiberidentifizierung} -- sofern identifizierbar --, der
Schreibort der jeweiligen \isi{Urkunde} und ihr Ausstellungsort gleichen oder
am gleichen Ort stets einheitlich geschrieben wurde,\is{Schreibdialekt}
...
% sęhent oder hȫrent lęsen} \wdef{Ich mache bekannt allen denen, die diese
...
\citet{cao-online}. Die Liste der Urkunden, die zu jedem Ort im Verzeichnis
ausgegeben werden, wurde zu diesem Zweck gecrawlt. In einem zweiten Schritt
wurden die verzeichneten Ausstellungsorte über eine Abfrage von Ortskoordinaten
in \citet{googlemaps} und \citet{wikipedia} georeferenziert, wobei die
automatische Zuweisung nachkontrolliert und manuell korrigiert wurde.

\begin{figure}
\includegraphics[
	trim=10mm 10mm 70mm 0, clip,
	width=\linewidth,
	keepaspectratio
]{./figures/deedsperplace.pdf}
\caption{Urkunden pro eindeutigem \CAO{}-Ausstellungsort
	(Hintergrundkarte nach \cite[Karte~47.4]{wiesinger1983})}

...
letzerem ist mittelhochdeutsch \norm{brief}, mit dem nicht nur Briefe, sondern
auch Urkunden bezeichnet werden, neben \norm{hantvėste}
\autocites[][s.\,v.~\fw{brief}]{mwb1}[][s.\,v.~\fw{hantveste}]{mwb2}[vgl.
auch][]{schmidtwiegand1998a}.

Das \CAO{} umfasst 4.617 Originalurkunden aus dem 13.\ Jahrhundert, das heißt
keine zeitgenössischen oder späteren Abschriften, von denen 4.289
deutschsprachig sind. Daneben existieren in weitaus geringerem Maße Urkunden
auf Mittelniederländisch und Latein
...
%
	...
	Nr.~4~W
		...
		Wolfenbüttel, Herzog August Bibl., Cod.~3.1~Aug.~2°: 1r--3vb;
...
Gegen\-stände geben \textcites[11]{schulze2011}[35--36]{ganslmayer2012}. Auch
die Thematik der verschiedenen Urkunden ist breit:
...
\autocite{ksw3,ksw2} versucht hier gegenzusteuern durch ein bezüglich Zeit,
...
%
	\footnote{Verzerrungen in der Beschriftung der Karte und im Kartenbild
		...
		Verarbeitung mit \citetitle{qgis}. Die Karte stellt die deutschen
		...
		Liechtensteins und der Schweiz, in denen zu dieser Zeit aufgrund
		der politischen Situation auch Deutsch gesprochen wurde. Eine
		vergleichbare Darstellung der mhd.~Dialekträume basierend auf
		historischen Quellen selbst, ohne Rückprojektion der neuzeitlichen
		Situation, ist mir nicht bekannt. Unter dem von \citet[4]{paul2007}
		geäußerten Vorbehalt, dass \textquote{die modernen Sprachraumkonturen
		keinesfalls vorschnell und unkritisch auf die mhd.\ Zeit übertragen
		werden \textins{dürfen}}, soll die Karte hier zur groben Orientierung
		dienen.}%
%
).
...
\section[Die \tit{Kaiserchronik}]{Die \tit{Kaiserchronik}}
...
darstellen; \citet[142]{chincaetal2019a} sprechen mit \citet{bumkepeters2005}
...
\crefrange{fig:kc_geospac_rough_12}{fig:kc_geospac_rough_15} deutlich machen

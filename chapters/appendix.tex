...
/yː/ vorlag (siehe \cref{fn:caoalemschwa,subsec:cao_adjflex_disc}). Um
...
Die folgenden Handschriftensignaturen werden neben denen der
\tit{Kaiserchronik} (siehe \cpageref{sec:hssverzkc}) im Text genannt. Da es
sich nicht in allen Fällen -- im weitesten Sinn -- um literarische Texte oder
deutschsprachige Werke handelt, existiert nicht zu jeder genannten Signatur ein
Eintrag im \tit{Handschriftencensus} (\tit{HSC}; \nosh\cite{hsc}).\\
...
Wien, Österreichische Nationalbibliothek, Cod. 2687
	& \autocite[6494]{hsc} \\
Wolfenbüttel, Herzog August Bibl., Cod. 3.1 Aug. 2º
	& \autocite[8396]{hsc} \\
\end{tabularx}

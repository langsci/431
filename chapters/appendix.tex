...
\REM{} und der \tit{Mittelhochdeutschen\il{Mittelhochdeutsch} Grammatik} von
\citet{ksw3,ksw2} sind durch Kursivierung gekennzeichnet.
...
in solchen Kontexten, in denen ursprünglich \norm{-iu} /yː/ vorlag. Um
...
\mr{2}{*}[-.5ex]{Ahd.}
	& \mr{2}{*}[-.5ex]{Mittelhochdeutsch\il{Mittelhochdeutsch}}
...
Luzern, Schönau i.\,Sw. und Staufen i.\,Br. (je 1). Hier entfallen von den
...
Promulgatio, also der Verkündigungsformel nahezu aller Urkunden im \tit{Corpus}

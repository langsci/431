\chapter{Liste der gesichteten Urkunden des \citetitle{Corpus der altdeutschen
Originalurkunden}}
\label{sec:urkliste}
...
mit dem \REM{} und der Stichprobe der \tit{Mittelhochdeutschen Grammatik}
...
in solchen Kontexten, in denen ursprünglich \norm{-iu} /yː/ vorlag (siehe
\cref{fn:caoalemschwa,subsec:cao_adjflex_disc}). Um sicherzustellen, dass
\lit{-i} in alemannischen Urkunden tatsächlich die ebenfalls für diese Region
typische Entrundung von \norm{-iu} darstellt und nicht etwa regelmäßig auch an
...
Aufbaus der Stichprobe zur Adjektivdeklination im \tit{Corpus der altdeutschen
...
Urkunden im \tit{Corpus} vor, wie in \cref{ex:fribr_hoerint} exemplarisch
angeführt.
...
\chapter{Belegzahlen zur Adjektivstichprobe aus dem \tit{Corpus der

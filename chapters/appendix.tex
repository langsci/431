...
\chapter{Handschriftenverzeichnis}
\label{ch:hssverz}
...
\section{Andere Handschriften}

Die folgenden Handschriftensignaturen werden im Text zusätzlich genannt. Da es
sich nicht in allen Fällen -- im weitesten Sinn -- um literarische Texte
handelt, existiert nicht zu jeder genannten Signatur ein Eintrag im
\tit{HSC}.\\

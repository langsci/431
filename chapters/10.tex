...
mittelhochdeutsch \norm{bėide} \wdef{beide} in Bezug auf zwei Referenten, nicht
...
Genus\-indifferentes\is{Genusindifferenz} \norm{si} \wdef{sie} stellt gefolgt
von \norm{wir} \wdef{wir} den häufigsten unmittelbaren Controller von
\norm{bėide} dar.
...
Kongruenz\is{Kongruenz!semantische} ($\text{\SM{}} \cap \text{\SF{}} \Rightarrow$~\norm{-iu}) in
...
Neben seiner Funktion als Quantor tritt \wdef{beide} im

...
mindestens ein Pronomen macht den Großteil der Belege aus
...
Gerade in \isi{Kontaktstellung} zu Personalpronomen wurde bei belebtem Bezug
die höchste Variation zwischen \norm{bėide} und \norm{bėidiu} beobachtet. Die
...
`Frau (\NeutF)', und sie mit \q{unproblematischen} Substantiven vergleicht.
Bezüglich des Bindungsverhaltens\is{Bindung} von Floating
Quantifiers\is{Floating Quantifier} wäre genereller auch der Vergleich mit
Reflexivpronomina und prädikativen Adjektiven\is{Adjektiv!prädikativ}
interessant, da auch sie sich im \isi{Mittelfeld} befinden und mit Subjekten
...
Subjektfunktion in Konstruktionen mit \isi{Floating Quantifier} näher zu

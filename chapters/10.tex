...
Die starke Adjektivdeklination im oberdeutschen\il{Oberdeutsch} Sprachraum der
mittelhochdeutschen\il{Mittelhochdeutsch} Periode macht im Nom.\ und Akk.\ Pl.\
noch einen Unterschied zwischen Maskulinum und Femininum gegenüber dem Neutrum
...
mittelhochdeutsche\il{Mittelhochdeutsch} Periode textkritische Editionen
lediglich zweier prominenter Verstexte der Artusepik als Quelle. Seine
Schlussfolgerungen zum konjunktionalen Gebrauch von \norm{bėide}
...
selbst keine formalen Genus\-merk\-male (mehr) vor, die per Concord verfügbar
...
mittelhochdeutschen\il{Mittelhochdeutsch} Texten das Default dar. Es tritt
...
Verteilung einen wichtigeren Faktor darstellt. Während \norm{bėidiu} im ganzen
...
explizit \q{problematische} Controller in diesem Kontext betrachtet, zum
Beispiel Lexical Hybrids wie \norm{wīp} `Frau (\NeutF)', und sie mit
\q{unproblematischen} Substantiven vergleicht. Bezüglich des Bindungsverhaltens
...
Adjektivdeklination zum Neuhochdeutschen\il{Neuhochdeutsch} hin das Flexiv
...
schließen: \foreignblockquote{english}[{Herman Melville\ia{Melville, Herman}:
Moby-Dick; \cite[159]{melville:mobydick}}]{It was stated at the outset, that
this system would not be here, and at once, perfected. You cannot but plainly

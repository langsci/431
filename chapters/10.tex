...
diplomatischer \isi{Transkription} vorliegen. Dies vereinfacht die
...
wären. Etwa drei Viertel der Targets\is{Target} mit gemischtgeschlechtlichem
Bezug (belebt\is{Animata} und unbelebt\is{Inanimata}) im \CAO{} weisen in
diesem Kontext \isi{Gender Resolution} auf. Die insgesamt bedeutend geringere
...
mit \isi{Inanimata} und, im Umkehrschluss, die maskulin-feminine Form mit
...
\autocite[11]{labov1994}. Gerade digitale Transkriptionen\is{Transkription}
erleichtern es aber enorm, an Belege und Beispiele zu kommen, selbst wenn keine
morphologische oder sogar syntaktische Annotation\is{Annotation} vorliegt.
% %

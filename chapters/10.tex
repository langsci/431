...
Vorkommen pro 1~Mio. Die Texte des \CAO{} und der \KC{} wurden mit Hilfe von
...
diesen Kontexten \isi{Distanzstellung} vor (\norm{\emph{N\tsub{i}} unde
\emph{N\tsub{j}} \dots\ bėide}), was die Wortabfolge\is{Abfolge} betrifft. Der
mittelbare Bezug auf zwei Controller über mindestens ein Pronomen macht den
Großteil der Belege aus (\isi{Kontaktstellung}: \norm{\emph{PRO\tsub{i+j}}
bėide}; Distanzstellung: \norm{\emph{PRO\tsub{i+j}} \dots\ bėide}).
...
prädikativen Adjektiven\is{Adjektiv!prädikativ} und
Reflexivpronomina\is{Reflexivpronomen} interessant, da sich erstere im
\isi{Mittelfeld} befinden und beide mit Subjekten koindiziert\is{Koindizierung}
sind, wobei sich beide zusätzlich in syntaktischen Domänen befinden, in denen
formale Kongruenz\is{Kongruenz!formale} eine Rolle spielt. Weiterhin könnte es
lohnend sein, die Überlegungen von \citet{spector2009} zur Spaltung von
Topik-\is{Topik} und Subjektfunktion in Konstruktionen mit Floating Quantifier

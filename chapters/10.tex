...
Sprachraum der mittelhochdeutschen\il{Mittelhochdeutsch} Periode macht im Nom.\
und Akk.\ Pl.\ noch einen Unterschied zwischen Maskulinum und Femininum
gegenüber dem Neutrum \autocite[182]{ksw2}. Die Wortform des hier exemplarisch
untersuchten quantifizierenden Determinierers \norm{bėide} `beide' lautet daher
je nach Kongruenzkontext \norm{bėide} (Nom./Akk.\ Pl.\ M./F.\ stark) oder
\norm{bėidiu} (Nom./Akk.\ Pl.\ N.\ stark).
...
für den derzeit ausstehenden Band zur Syntax zu erwarten.
...
bėide}), was die Wortabfolge betrifft. Der mittelbare Bezug auf zwei Controller
...
Controller auf, und zwar etwas häufiger als die erwartete Form \norm{bėide}.
Für diese Kombination liegen aber insgesamt nur sechs Belege vor; kombinierte
feminine Controller sind im Belegmaterial keine vorhanden.
...
(sowohl belebten\is{Animata} als auch unbelebten) kann mit diesem Ansatz nicht
erklärt werden. Anzunehmen ist, dass die Defaultform als solche
übergeneralisiert auch auf ansonsten unproblematische Kontexte mit kombinierter
Referenz angewendet wird. Diese Möglichkeit wird von \citet[302]{corbett1991}
angeführt, allerdings im Rahmen seiner Untersuchungen zum

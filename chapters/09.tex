...
\ex \label{ex:richtherriu3}
	\begin{xlist}
	\ex \gll Die rihtær ſprachen beideu {dar z\sscr{u}{o}} \\
...
\ex \label{ex:gendassgmt2}
	\gll Die richtare ſprachen dar beide z\sscr{u}{o}. \\
...
wie \norm{wīp} \wdef{Frau (\NeutF)} interessant,\is{Desiderat} da dadurch
...
Ein Beispiel für \isi{Genusresolution} im Bezug auf belebte Controller wird
in \REF{ex:gendres2} gegeben. Hier treten \lit{R\sscrit{v}{o}diger} \wdef{Rüdiger
(\MascM)} und \lit{ſin hovſfrowe} \wdef{seine Ehefrau (\FemF)} als kombinierte
Controller auf, die durch das Target\is{Target} \lit{bediv} \wdef{beide
...
maskuline und feminine Referenten bezeichnet. Die Analyse der einzelnen
Pluralcontroller in den Kapiteln~\ref{ch:caoanalyse} und~\ref{ch:kcanalyse} für die
oberdeutschen\il{Oberdeutsch} Urkunden und diejenigen \KC{}-Handschriften
verdeutlicht dies, insofern dort im Plural das Neutrum noch klar vom
Masku\-li\-num-Femi\-ninum unterschieden wird. Nach rein formalen Kriterien wäre also
keine Genusresolution notwendig.
...
\ex \label{ex:m+m_inan_e}
	...
	\ex \label{ex:m+m_inan_e_2}
		\gll einen Weingarten \textelp{} Vnd einen Chr\sscr{v}{o}tgarten
...
da manchmal beide Lesarten\is{Lesart} -- gefloatet\is{Floating Quantifier} und
...
vor benant g\sscrit{v}{o}lte dem andern werden di weil ez lebet · Di weil ſi peidev lebent
...
\ex \label{ex:m+f_si_beide_iu}
	...
	\ex \label{ex:m+f_si_beidiu}
		\gll hern Perhtolden dem Meinchovær vnd ſiner h\sscr{o}{v}ſfrowen ver Magereten
	...
	\ex \label{ex:m+f_si_beide}
		\gll Her Ernſt · vnſer burger / vnd ver Gerdr\sscr{o}{e}vt ſein hovsvrowe / da
				ſi baide lebten \\
...
\ex\label{ex:papstkoenig5} % 224
	...
	% \gll Zegot ſt\sscr{u}{o}nt allr ir geſín {/} \\
...
\isi{Floating Quantifier} ähnlich wie ein prädikatives Adjektiv verhalten, da
...
Floating Quantifier entsprechend eine Position zwischen \emph{attributive} und
...
\ex\label{ex:insigel2}
	\gll mit der ſtet Jnſigel ze auſpurch / vn̄ mit vnſerm Jnſigel d\sscr{ı}{e}v baid\sscr{ı}{e}v
			dran hangent \\
...
\ex \label{ex:m+m_inan_e3}
	\gll einen Weingarten \textelp{} Vnd einen Chr\sscr{v}{o}tgarten \textelp{} ·
...
\begin{xlist}
	\ex \label{ex:iclgr2_1}
		\gll % vnd verzeih mich / \textelp{}
			dez Cehenten vnd der h\sscr{u}{o}b / dev paidev {vor benemt} ſint \\
			% und verzichte mich {} {}
...
\ex \label{ex:m+m_beidiu_1}
	\gll Die rihtær ſprachen beideu {dar z\sscr{u}{o}} \\
		die Richter[\textsc{nom.pl.\MascM}] sprachen
		beide-\textsc{nom.pl.\NeutM.st} dazu \\
	\trans \wdef{Die Richter äußerten sich beide dazu}
		(%
...
beiden Herren \lit{R\sscrit{u}{o}d}\textins{\norm{iger}/\norm{olf}?} und \lit{\sscrit{v}{o}lrich}
oder auf \lit{Jungherren} \wdef{Junker}. In jedem Fall ist die Kongruenzform von
\norm{bėide} anomal.

\begin{exe}
\ex \label{ex:m+m_beidiu_3}
	\gll Diſ dingeſ gezuga ſint · R\sscr{u}{o}d · von der palma min \sscr{O}{e}hen · \sscr{v}{o}lrich
			von Gr\sscr{v}{e}nenberch min \sscr{O}{e}hen bedu Jungherren \textelp{} \\
...
der Urkunde um die drei Brüder \lit{wezel vn̄ hainrich wezel vnde C\sscrit{v}{o}nrat
...
zitierten Beleg an. Dort steht in Bezug auf die Abstrakta \lit{l\sscrit{ı}{e}be}
\wdef{Liebe} und \lit{ſch\sscrit{o}{e}ne} \wdef{Schönheit} das
...
oder \norm{wir} \wdef{wir}. Das Personalpronomen ist in allen untersuchten
Kontexten genus\-indifferent\is{Genusindifferenz}, gibt also selbst keine
...
\ex \label{ex:caoconjbeide}
	...
	\ex \label{ex:caoconjbeide_1}
		\gll beidiu Einwige vnd auch dem kl\sscr{o}{e}ſter \\
	...
	\ex \label{ex:caoconjbeide_2}
		\gll béd\sscrit{v}{i} herne heſſin / vnde herne R\sscr{v}{o}dolfeſ \\
...
diskutiert. Obwohl die Präpositionalobjekte in \REF{ex:caokoordsyn_3_2} und
\figref{fig:caokoordsyn_3_2} jeweils Personenmerkmale\is{Personenmerkmal}
...
vorhanden, nach denen \lit{Beideu} \wdef{beide} flektieren könnte.

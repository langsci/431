...
(Sexus) keine Schnittmenge bilden können wie in \figref{fig:sexintersect}
...
%
Das semantische \isi{Sexusmerkmal}\is{Merkmale!semantische} wird
also in Abwesenheit des formalen
...
Kombination von männlicher und weiblicher Referenz wird daher am Target zu
einem Neutrum aufgelöst.
...
ein Personal-\is{Personalpronomen} oder Relativpronomen\is{Relativpronomen}
zwischen \isi{Erstcontroller} und \norm{bėide}-Target. Das Pronomen selbst ist
damit sowohl Target als auch \isi{Controller}, wie in dem Schema in
...
häufigen Fall wird das \isi{Sexusmerkmal} dem Anschein nach formal aufgelöst,

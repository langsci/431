...
Ausnahme\is{Ausnahme} der Abhängigkeit von pronominalen Controllern mit
belebter\is{Animata} Referenz. Der Beleg in \REF{ex:m+m_beidiu_1} enthält ein
\norm{bėidiu}-Target, das sich unmittelbar auf das Plural-Maskulinum
\lit{rihtær} `Richter' bezieht, das seinerseits männlich denotiert ist.
...
auf ein Hybrid Noun wie \norm{wīp} `Frau (\NeutF)' als Controller beim Target
in gefloateter Position eher formale (\norm{-iu}) oder semantische Kongruenz

...
bis auf wenige Ausnahmen regelmäßig formale Kongruenz\is{Kongruenz!formale}.
...
aufgelöst. Ein männlich und ein weiblich denotierter\is{Denotation} Controller
ergeben zusammen also eine Form vom Typ \norm{bėidiu} und damit ein Neutrum.
Etwas differenzierter ist die Lage bei den Belegen mit indirektem Bezug
zwischen Controller und \isi{Target}. Hier steht in der Regel ein
Personal-\is{Personalpronomen} oder Relativpronomen\is{Relativpronomen}

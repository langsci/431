...
der einzelnen Pluralcontroller in \sectref{ch:caoanalyse,ch:kcanalyse} für die
...
(vgl.~\sectref{subsubsec:perscombsgnp,subsubsec:conomctrlpers}). Ein Beispiel für
...
\sectref{sec:caotargdist,sec:kctargdist}) hat ergeben, dass die Targets in diesen
...
\cref{ex:pronindir_1} das Objekt darstellt (vgl.~\sectref{sec:floatquant} zu

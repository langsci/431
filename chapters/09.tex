...
Raum\is{Sprachgeografie} Zürich um 1300 entstand \autocite[4957]{hsc}.
...
Unter einer geografischen\is{Sprachgeografie} Perspektive ist festzustellen,
...
und mittelbairischen\il{Bairisch} Sprachraum\is{Sprachgeografie} betroffen.
...
jeweilige geografische\is{Sprachgeografie} Verbreitung der beiden Typen
aufgrund der aus dem \CAO{} gewonnenen Belege. Während \norm{bėidiu} im ganzen
oberdeutschen\il{Oberdeutsch} Sprachraum\is{Sprachgeografie} verbreitet ist,
...
\caption{Geografische\is{Sprachgeografie} Distribution der Form \norm{bėide} in

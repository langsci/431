...
System wie im Färöischen\il{Färöisch} oder im Isländischen
...
% %
% 	\footnote{Für das Färöische\il{Färöisch} bzw.\ das Isländische geben
...
\norm{sie bėidiu} in bairischen\il{Oberdeutsch!Bairisch} und \norm{siu bėide}
in alemannischen\il{Oberdeutsch!Alemannisch} Urkunden davon auszugehen, dass
...
Diese Orte liegen alle im alemannisch-\il{Oberdeutsch!Alemannisch} und
schwäbischsprachigen Gebiet. Im Fall der \KC{} sind die Handschriften K und B1
aus dem alemannischen\il{Oberdeutsch!Alemannisch} beziehungsweise aus dem
mittelbairischen\il{Oberdeutsch!Bairisch} Sprachraum betroffen. Damit stammen
...
alemannischen\il{Oberdeutsch!Alemannisch} Quellen
...
alemannischen\il{Oberdeutsch!Alemannisch} Urkundenschreibern
...
alemannischen\il{Oberdeutsch!Alemannisch} Urkunden des späten 13.~Jahrhunderts
...
alemannischen\il{Oberdeutsch!Alemannisch} Gebiet um 1300 nicht mehr klar
erkennbar war.
...
zumindest mit PPs schon in vormittelhochdeutscher\il{Mittelhochdeutsch} Zeit
möglich.
...
gewonnenen Belege. Während \norm{bėidiu} im ganzen oberdeutschen Sprachraum
verbreitet ist, finden sich Belege für \norm{bėide} im
Alemannischen,\il{Oberdeutsch!Alemannisch} Ostfränkischen und im Osten des
Mittelbairischen\il{Oberdeutsch!Bairisch}. Überall dort kommt es zu einem
...
das Alemannische\il{Oberdeutsch!Alemannisch} als auch für das Bairische 89\,\%
\norm{bėidiu} verzeichnen, für das Übergangsgebiet dazwischen aber 100\,\% (für
das Ostfränkische liegen für diesen Zeitabschnitt keine Daten vor).

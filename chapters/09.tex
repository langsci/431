...
Abhängigkeit von den kombinierten Personenmerkmalen\is{Personenmerkmal} ihrer
\isi{Controller} in \sectref{sec:caotargpers} und \sectref{sec:kctargpers}
lassen sich wie in \tabref{tab:caokcrules_1} und \ref{tab:caokcrules_2}
zusammenfassen. Auf die Reihenfolge der Referenten kommt es dabei nicht an,
ebenso wenig auf den Wortformenabstand\is{Distanz!lineare} zwischen
\isi{Controller} und Target. Bei den Urkunden hatte sich gezeigt, dass ein
...
Personenmerkmale\is{Personenmerkmal}, von denen Geschlecht -- grammatisches
(\isi{Genus}) oder semantisches (Sexus) -- eines ist. Für die Kombination der

...
Merkmalen\is{Merkmale!semantische} Person (\textsc{pers}), \isi{Numerus}
(\textsc{num}) und \isi{Sexus} (\textsc{sex}). Formal wird vom Pronomen
\norm{si} aber kein \isi{Genus} (\textsc{gend}) festgelegt, mit dem sein Target
kongruieren könnte.

...
\ex\label{ex:gendasshier}
	\begin{enumerate}[noitemsep]
		\item inhärentes grammatisches Geschlecht (wenn die NP einen \isi{Kopf}
...
sich jedoch kein einzelner, eindeutiger Phrasenkopf\is{Kopf} (\xhead{N})
...
Controllern, dass eine koordinierte NP kein Kopf\-nomen\is{Kopf} beinhalte,
...
drei (siehe \figref{fig:npconstit}).%
%
...
kongruieren.\is{Kongruenz!prädikativ}\is{Merkmale!grammatische}
...
werden.\is{Kongruenz!prädikativ} \citet[310--311]{fleischer2007} zufolge zeigen
...
Adjektivs\is{Adjektivdeklination} nicht mit seinem Subjekt übereinstimmt,
...
linken Seite bilden \norm{man unde wīp} zusammen eine NP, die wiederum zusammen
mit der QP \norm{bėiden} eine DP\is{Determiniererphrase} bilden, die als

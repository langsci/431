...
Kraft, da hier keine semantischen Geschlechtsmerkmale geltend gemacht werden
können, sondern nur formale.
...
\norm{man} `Mann' und \norm{wīp} ihre \isi{Index}-Merkmale zu einem Plural
...
lediglich wichtig, dass bei Koordination das \isi{Index}-Merkmal der Konjunkte
...
zusammengenommen haben ihrerseits ein \isi{Index}-Merkmal, das hier allerdings
dem \isi{Index} $i$ entspricht, da $g_1$ keine neuen Informationen hinzufügt.
In der C-Struktur auf der linken Seite bilden \norm{man unde wīp} zusammen eine

...
ein Subjekt mit den Personenmerkmalen \textsc{3.~person} und
...
Dies wird anhand von \cref{ex:fstructdomains} verdeutlicht.
...
seiner Verwendung innerhalb der DP ein Merkmal \textsc{quant} definiert, da er
aufgrund des distributiven Unterschieds zu Adjektiven nicht als Teil der Menge
der Adjunkte (\textsc{adjc}) gezählt werden sollte.
...
Quantor. Parallel zu \textsc{subj} und \textsc{top} werden hier die Rollen \textsc{obj} und \textsc{foc}

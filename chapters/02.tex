...
Unterscheidung liefert ihnen die \fw{\isi{Head-driven Phrase Structure Grammar}}
...
und der Bindung\is{Bindung} von Reflexivpronomen sichtbar
\REF{ex:explvbkonj}.
...
\phantomsection
\label{phsec:concord}
Das Gegenstück zum Index bildet Concord, das in der HPSG\is{Head-driven Phrase
Structure Grammar} Teil des Kopfmerkmals ist \autocite[17]{wechslerzlatic2003}.
Das Merkmal \emph{Concord} existiert ebenso in der LFG
...
Deutschen\il{Neuhochdeutsch} für einzelne, unkoordinierte NPs weitgehend
...
\is{Distribution!syntaktische} von Kongruenz zeigenden Wortarten, deren
...
\isi{Concord}-Merkmalen, da sie NP-intern auftreten. Aufgrund induktiver
Kriterien ergibt sich das Schema in \figref{fig:theoagrdist}.

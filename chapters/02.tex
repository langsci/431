...
Controller und Target auf die Wahl der Kongruenzform auswirkt \autocites%
	(siehe auch \sectref{sec:ctrltarg,sec:kongrhier})%
...
\autocites(vgl.~auch
\sectref{sec:ctrltarg,sec:lfgkongr})[181--184]{ksw2}[772]{woellstein2022}.
...
\cref{fig:qfgg} an (die Pfeile wurden zur Verdeutlichung der postulierten
...
\cref{fig:siebeidefhrd_1,fig:siebeidefhrd_2} den Beispielen bei
...
Während der Satz in \cref{fig:siebeidefhrd_1} mit gefloatetem Quantor
ausschließlich die Lesart zulässt, bei der beide Parteien jeweils ein Fahrrad
besitzen (distributive Lesart), lässt das Beispiel in \cref{fig:siebeidefhrd_2}
...
Analyse von Daten, wie sie in \sectref{ch:caoanalyse,ch:kcanalyse} vorgenommen
wird.

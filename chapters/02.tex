...
zeigen sich jedoch in einem Portmanteau-Morphem zusätzlich zum \isi{Kasus} des
...
\isi{Genus} und \isi{Numerus} tendenziell an semantische
Eigenschaften\is{Merkmale!semantische} der bezeichneten\is{Denotation} Person
gebunden; bei Dingen und Abstrakta ergeben sie sich anhand formaler
Kriterien\is{Merkmale!grammatische} \autocites[vgl.][2--4,
...
Merkmals \emph{Genus}. Doch dass etwa \fw{Baum} maskulin und \fw{Liebe}
feminin ist, hat kein Korrelat in der außersprachlichen Realität, sondern ist
eine \isi{Konvention} des Deutschen\il{Neuhochdeutsch}.%
%
...
Personen\-merkmale\is{Personenmerkmal} wie Person, \isi{Numerus} und
\isi{Genus} \autocite[15--17]{wechslerzlatic2003}. Auch in der mit der
...
strukturelle Merkmal \emph{\isi{Kasus}}, dafür spielt \emph{Person} hier keine
Rolle. Kongruenz über das Merkmal \emph{Concord} herrscht typischerweise
zwischen einem nominalen \isi{Kopf} und seinen Modifizierern, was in der
...
formal\is{Kongruenz!formale} in den Kategorien \isi{Kasus} (\textsc{case}),

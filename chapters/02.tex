...
Positionen des gestrandeten Quantors vor. Für das Englische \fw{all} `alle' mit
Bezug auf das Subjekt gibt \citet{merchant1996} grob die Konstituentenstruktur
in \figref{fig:qfgg} an (die Pfeile wurden zur Verdeutlichung der postulierten
...
\REF{fig:hebrqf}. Anders als im Deutschen oder im Französischen kongruiert der
gefloatete Quantor (\fw{kol} `alle') dort nicht bloß, sondern beinhaltet ein
klitisches Pronomen, das mit dem Quantifizierten koindiziert ist.%
%

...
der \xbar{X}-Theorie \autocites{chomsky1970,jackendoff1977} darstellt.
Projektionen innerhalb des Baumes können dabei funktional annotiert sein;
nicht-verzweigende \xbar{X}-Kategorien werden als überflüssig angesehen und in
der Regel weggelassen, wie in \figref{fig:cfstruct}, wo kein struktureller
Unterschied zwischen Spezifikator, \isi{Adjunkt} und \isi{Komplement} gemacht
wird, weil die Annotation\is{Annotation} disambiguiert.

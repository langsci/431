...
steht \fw{sich} als Objekt in einer anderen F-Struktur\is{funktionale Struktur}
als das Subjekt ($j$ gegenüber $g$). Da aber Subjekt und Objekt vom gleichen
Verb \fw{putzen} abhängen, befinden sich beide dennoch innerhalb derselben
...
nicht in der F-Struktur\is{funktionale Struktur} miteinander vereinigt
...
$h$) sind koindiziert ($i$), um die anaphorische\is{Anapher} Funktion von

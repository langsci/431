...
zunächst \term{Controller} (Kongruenzauslöser) und \term{Target}
(Kongruenzziel).%
%
...
vgl.~\cite[8--17]{wechslerzlatic2003}). Die theoretische Grundlage für diese
Unterscheidung liefert ihnen die \isi{Head-driven Phrase Structure Grammar}
...
Feature Principle}\is{Head Feature Principle} begründet wird. Dieses besagt im
...
sogenannte \term{Lexical Hybrids}\is{Lexical Hybrid}, also
...
Bei \term{Lexical Hybrids}\is{Lexical Hybrid} im engeren Sinn liegt ein Konflikt
...
Eine andere Spielart von Lexical Hybrids liegt bei \term{Epikoina} vor, also im

...
Beispiel ein Adjektiv\is{Adjektiv!attributiv} oder ein Artikel, oder auch ein
anderer Kopf, der anaphorisch\is{Anapher} von diesem Substantiv abhängt, wie
ein Pronomen. Kongruenz zeigt sich daneben auch in der Übereinstimmung des
...
\textsc{pronomen}~(\textsc{dat}) -- \textsc{artikel}~(\textsc{acc}) --

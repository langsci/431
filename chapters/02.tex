...
\caption{Beispiel für eine Attribut-Wert-Matrix \autocite[adaptiert
	nach][209]{mueller2023}}
\label{fig:avm}
\end{figure}
...
Abbildung \figref{fig:lfgcoord_1} und \ref{fig:lfgcoord_2} noch einmal zur
Illustration die jeweils grammatisch akzeptablen Varianten vor dem Hintergrund
des gewählten Theorieframeworks gezeigt. Die Annotation der koordinierten NPs

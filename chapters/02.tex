...
\fw{covert gender},\is{Genus} bei dem die Klassenzugehörigkeit eines
...
anaphorische Referenzierungen\is{Anapher} erleichtern}, zum Beispiel, indem
häufig im gleichen Kontext genannte Dinge unterschiedliche Genera besitzen
\autocite[dazu auch][320--323]{corbett1991}. Darüber hinaus vermag Genus auf
der Ebene der Pragmatik die Einstellung einer Sprecherin oder eines Sprechers
zu signalisieren, was Respekt oder Verachtung, Zu- oder Abneigung gegenüber
einer Person durch die Verwendung des \q{richtigen} oder \q{falschen} Genus in
...
Genus\-gebrauchs im sozialen Geschlecht\is{Gender} (\fw{social gender}) als
Bindeglied zwischen biologischem und grammatischem Geschlecht. Sie attestieren
dieser Ebene, die den sozialen oder ontologischen Status eines Individuums
anspricht, eine starke emotionale Komponente, wenn durch
abweichenden\is{Ausnahme} Genus\-gebrauch zum Beispiel despektiertlich
kommuniziert wird, dass sich eine Person nicht in Einklang mit der ihr
zugemessenen Geschlechterrolle verhält. Abgesehen von lexikalisierten Fällen
von abweichendem\is{Ausnahme} Genus wie mittelhochdeutsch\il{Mittelhochdeutsch}
\norm{wīp} `Frau' (Neutrum mit Bezug auf eine weibliche Person) oder
\norm{kindelīn} `Kindlein' (Neutrum mit Bezug auf junge Menschen), spielt
situativ abweichender\is{Ausnahme} Genusgebrauch bei Personen im Belegmaterial
keine Rolle.
...
\posscite[99]{dahl1999} ist Belebtheit, also der Unterschied zwischen
belebten\is{Animata} und unbelebten Entitäten, in den Grammatiken menschlicher
Sprachen so allgegenwärtig, dass sie tendenziell als selbstverständlich
hingenommen und damit unsichtbar wird.%
%
...
von anaphorischen\is{Anapher} Targets haben, möchte ich im Folgenden formale
und semantische Geschlechtsmerkmale in der Annotation von Beispielen konsequent
...
grammatische Merkmale derselben Kategorie (Genus, Numerus) pro \isi{Controller}
...
genusindifferent ist, muss der Unterschied zwischen den einzelnen
Controllern\is{Controller} durch die Kombination ihrer Personenmerkmale
aufgelöst werden, damit das Target regelgemäß kongruieren kann

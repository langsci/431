...
darin, dass das Urindoeuropäische\il{Indoeuropäisch} vor der Abspaltung des
...
\begin{table}
\centering
\caption{\fw{*h₂}-Derivate im Urindoeuropäischen\il{Indoeuropäisch}}
\begin{tabular}[t]{
	l @{} l @{} l @{~} l
	c
	l @{} l @{} l @{~} l
...
%
	...
	Russisch\il{Russisch}, Spanisch\il{Spanisch}

...
NP; \cite[vgl.][8--17]{wechslerzlatic2003}). Die theoretische Grundlage für
diese Unterscheidung liefert ihnen die \fw{\isi{Head-driven Phrase Structure
...
gestellt werden, im Belegmaterial nicht vorkommen,\is{Komplexitätsreduktion}
gehe ich bei der Klassifizierung meiner Daten von cis- und heteronormativen
Gegebenheiten aus.

Wenn im Weiteren vereinfachend\is{Komplexitätsreduktion} von \textit{Sexus} als
...
%
	...
	\citet{dalrymple2001} benutzt \emph{\isi{Spezifikator}} (\textsc{spec}) als
	grammatische Funktion bei der \isi{Annotation} des
	...
	als sinnvoll für die Analyse von NPs im Deutschen\il{Neuhochdeutsch}
	erachtet.}
%

...
zum Beispiel \norm{burgǟre} anders als in \cref{ex:nongenmasc} keine
...
koordinierten NPs folgt \citet{peterson2004}. In \figref{fig:lfgcoord_1} erfordert
...
Subjekt-NP in $g$; zwei Singulare ergeben zusammen einen Plural.%
%
...
im Mittelfeld steht \cref{ex:sibeideambig}. Kontaktstellung ist also nicht
...
\cref{ex:disjointctrl_2} unter formalen Kriterien noch lockerer. So bezieht

...
und NP ein, wie in \figref{fig:nomstack} dargestellt (vgl.~auch \cite[44--45 mit
...
Subjekt-NP aus ihrer Position hinter dem Quantor aus der Verbphrase
...
\citet{sportiche1988} und \citet{shlonsky1991} auf das Deutsche und nimmt
weitere Verfeinerungen ihrer Theorie bezüglich möglicher Positionen des
gestrandeten Quantors vor. Für das Englische \fw{all} `alle' mit Bezug auf das
...
\citet{shlonsky1991} für das Ivrit, siehe \REF{ex:hebrqf} und \REF{fig:hebrqf}.
Anders als im Deutschen oder im Französischen kongruiert der gefloatete Quantor
...
Die Analysen von \citet{shlonsky1991} und \citet{spector2009} für das Ivrit
...
Schema in \figref{fig:beidepost_2dist} als Arbeits\-hypothese für die Lesart mit
...
\ex\label{ex:disjointctrl_1}
	...
	\gll % das
			vur Agneſ$_i$ mit hern Lukas$_j$ hant \textelp{}
			% het gegeben ze coͧffenne \textelp{}
			vn̄ hant bedi$_{i+j}$ veriehen, 

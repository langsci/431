...
einzelne, unkoordinierte\is{Koordination} NPs weitgehend deckungsgleich mit
...
%
Zu den Merkmalen \emph{\isi{Numerus}} und \emph{\isi{Genus}} tritt das
...
einem nominalen \isi{Kopf} und seinen Modifizierern, was in der
HPSG\is{Head-driven Phrase Structure Grammar} mit dem \fw{\isi{Head Feature
Principle}} begründet wird. Dieses besagt im Grunde, dass ein
Phrasenkopf\is{Kopf} seine grammatischen Informationen mit seinen Töchtern
...
In Bezug auf koordinierte Substantive\is{Substantiv}\is{Koordination} wie in
...
kursorische Suche im \REM{}\il{Mittelhochdeutsch} nach dem inalienablen Typ mit

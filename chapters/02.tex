...
Kongruenz aufweisen, sich also auch die syntaktische Domäne von Controller und
Target auf die Wahl der Kongruenzform auswirkt \autocites%
...
wie sein Controller (gleiche NP). Auf \fw{Katze} ist ebenfalls der Possessor
\fw{Janas} in $h$ bezogen. \fw{Janas} und \fw{Katze} befinden sich zwar in
...
%
	\footnote{Die Annotationsform\is{Annotation}
		...
		Funktion $x$ als Controller existiert, die ein Attribut\is{Attribut}
		$a$ besitzt, das den Wert $v$ für sein Target voraussetzt
...
bei Attributen\is{Attribut} zu erwarten ist, da innerhalb der NP Concord das
...
und kongruieren in Index-Merkmalen, möglicherweise auch in Concord-Merkmalen,
da sie NP-intern auftreten. Aufgrund induktiver Kriterien ergibt sich das
Schema in \figref{fig:theoagrdist}.

...
Merkmale\is{Merkmale!grammatische} trägt: \emph{maskulin}, \emph{Singular}.
Ferner sei angenommen, dass es im \im{Nominativ} steht. Die Merkmale
\fw{maskulin} und \fw{Singular} sind dem Lexikoneintrag\is{Lexikon} des Wortes
...
\isi{Kasus} des Substantivs als Suffix \fw{-er} am
Adjektiv\is{Kongruenz!attributive} \fw{grün}, das von sich aus keine
Personenmerkmale\is{Personenmerkmal} und Informationen zum Kasus der
\isi{Nominalphrase} (NP) enthält. Personen- und Kasusmerkmale des Substantivs
werden durch die Flexion am Adjektiv widergespiegelt und erscheinen daher
\q{verschoben}. Das Adjektiv\is{Adjektiv!attributiv} ist damit das Target der
...
gebunden; bei Dingen und Abstrakta ergeben sie sich anhand formaler Kriterien
...
\emph{Genus}. Doch dass etwa \fw{Baum} maskulin und \fw{Liebe} feminin ist, hat
kein Korrelat in der außersprachlichen Realität, sondern ist eine
...
zwischen Lexical Hybrids im engeren Sinn und Epikoina\is{Epikoina}.
...
in die LFG\is{Lexical-functional Grammar} aussehen? Diesen Versuch unternimmt
\citet{spector2009} in Rückgriff auf \citet{shlonsky1991} für das \ili{Ivrit},
siehe \REF{ex:hebrqf} und \figref{fig:hebrqf}. Anders als im
Deutschen\il{Neuhochdeutsch} oder im Französischen\il{Französisch} kongruiert
der gefloatete Quantor (\fw{kol} `alle') dort nicht bloß, sondern beinhaltet
ein klitisches Pronomen, das mit dem Quantifizierten

...
Ferner sei angenommen, dass es im \feat{Nominativ} steht. Die Merkmale
\feat{maskulin} und \feat{Singular} sind dem Lexikoneintrag\is{Lexikon} des
Wortes inhärent; sie werden nicht morphologisch an ihm markiert. Die
grammatischen Informationen zeigen sich jedoch in einem Portmanteau-Morphem
zusätzlich zum \isi{Kasus} des Substantivs als Suffix \fw{-er} am
Adjektiv\is{Kongruenz!attributive} \fw{grün}, das von sich aus keine
Genusmerkmale\is{Genusmarkierung} und Informationen zum Kasus der
\isi{Nominalphrase} (NP) enthält. Genus- und Kasusmerkmale des Substantivs
...
\fw{Mutter} hat damit \feat{feminin} als Wert des grammatischen Merkmals
\feat{Genus}. Doch dass etwa \fw{Baum} maskulin und \fw{Liebe} feminin ist, hat
...
Merkmal \autocite[189--190]{bresnanetal2016}. Das Merkmal \feat{Index} bildet
die Basis für anaphorische\is{Anapher} Referenz, indem es ein Individuum oder
ein Ding als Instanz des Bezeichneten im Diskurs verankert\is{Diskursanker}
...
%
Zu den Merkmalen \feat{Numerus}\is{Numerus} und \feat{Genus}\is{Genus} tritt das
strukturelle Merkmal \feat{Kasus}\is{Kasus}, dafür spielt \feat{Person} hier
keine Rolle. Kongruenz über das Merkmal \feat{Concord} herrscht
...
\autocites[vgl.][34]{pollardsag1994}[22]{wechslerzlatic2003}. Daher ist anders
als \feat{Index} das Merkmal \feat{Concord} lokal auf die NP\is{Nominalphrase}
beschränkt, während das Merkmal \feat{Index}\is{Index} überall dort vorkommt,
wo anaphorische\is{Anapher} Bindung\is{Bindung} eine Rolle spielt
...
\feat{belebt} und \feat{unbelebt}, sondern viele Übergangs- und
...
Wenn im Weiteren vereinfachend\is{Komplexitätsreduktion} von Sexus als
...
formal feminin ist, sich aber der Wortbedeutung nach auf einen Menschen
...
\textit{und}, Wortformen wie \wdef{Baum}, A-Strukturen\is{Argumentstruktur} wie
...
Werte zugewiesen; Funktionen (\feat{subj}, \feat{obj}, etc.) können nur
...
Personenmerkmalen\is{Personenmerkmal} \feat{3.~Person} und \feat{Plural} in
...
der Quantor als Merkmal\is{Merkmale!grammatische} (\feat{quant}) definiert,
da er aufgrund des distributiven Unterschieds zu Adjektiven nicht als Teil der
Menge der Adjunkte\is{Adjunkt} (\feat{adj}) gezählt werden sollte.
...
mit gefloatetem Quantor. Parallel zu Subjekt (\feat{subj}) und
\isi{Topik} (\feat{top}) werden hier die Rollen Objekt (\feat{obj}) und
\isi{Fokus} (\feat{foc}) für \norm{bėidiu} und die dazugehörige

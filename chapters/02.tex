...
Person und Numerus mit seinem Subjekt. \citet[20]{corbett2006} fasst die
...
\isi{Genus} und Numerus tendenziell an semantische Eigenschaften der
...
enthält, konkret also grammatikalisierte Personen\-merkmale wie Person, Numerus
und \isi{Genus} \autocite[15--17]{wechslerzlatic2003}. Auch in der mit der
HPSG\is{Head-driven Phrase Structure Grammar} verwandten \fw{Lexical-Functional
Grammar} (LFG; \cites{kaplanbresnan1982}{bresnan2001}{bresnanetal2016})
existiert ein solches Merkmal \autocite[189--190]{bresnanetal2016}. Das
Index-Merkmal bildet die Basis für anaphorische\is{Anapher} Referenz, indem es
...
und der Bindung\is{Bindung} von Reflexivpronomen sichtbar \REF{ex:explvbkonj}.
...
%
Zu den Merkmalen Numerus und \isi{Genus} tritt das strukturelle Merkmal Kasus,
...
Kategorie (Genus\is{Genusmerkmal}, Numerus) pro \isi{Controller} vorliegen. Die
Frage in diesem Fall ist, wie ein Target, das für die jeweilige Kategorie
flektiert, mit diesen divergierenden Merkmalen umgeht. Eine Möglichkeit der
Konfliktlösung besteht darin, lediglich mit dem nächsten Konjunkt zu
kongruieren \autocites[\fw{closest conjunct agreement}\is{Closest Conjunct
Agreement}; vgl.][179--180]{corbett1983}[168--170]{corbett2006}, wie in dem
Schema in \figref{fig:ccagraphic} gezeigt.
...
Numerus mit dem \isi{Concord}-Merkmal\is{Merkmale!grammatische} jedes einzelnen
der beiden Konjunkte übereinstimmt, damit Kongruenz hergestellt werden kann und
ein kohärenter\is{Kohärenz}, grammatisch wohlgeformter Ausdruck entsteht.%
%
...
(\textsc{gend}) und Numerus (\textsc{num}) über ein fusionales Suffix, das
diese Eigenschaften kombiniert kodiert \autocites(vgl.~auch

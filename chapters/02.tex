...
dass die indoeuropäische Ursprache\il{Indoeuropäisch} vor der Abspaltung des
...
matrices}; \cites[vgl.][44--45]{bresnanetal2016}[Kapitel 6]{mueller2020}), die
Informationen strukturiert präsentieren, vergleiche \REF{ex:avm}. Als Attribute
in der linken Spalte dienen Funktionen oder Merkmale wie \textsc{subjekt},
\textsc{prädikator}, oder \textsc{numerus}. Zugehörige Werte in der rechten
Spalte können grammatische Eigenschaften wie \textsc{plural}, Funktionsmorpheme
wie \textit{und}, Wortformen wie `Baum', A-Strukturen wie
\astruct{schreiben}{\ups{subj}, \ups{obj}} sowie F-Strukturen oder Mengen von
F-Strukturen sein. Jedem Attribut sind dabei ein oder mehrere eindeutige Werte
zugewiesen; Funktionen (\textsc{subjekt}, \textsc{objekt}, etc.) können nur
...
Deutschen\il{Neuhochdeutsch} zusätzlich Bedingungen an \textsc{index}-Merkmale.
...
im Deutschen\il{Neuhochdeutsch} außerdem nicht prädikativ gebraucht werden, wie
...
DP ein Merkmal \textsc{quant} definiert, da er aufgrund des distributiven
Unterschieds zu Adjektiven nicht als Teil der Menge der Adjunkte (\textsc{adj})
...
Deutsche\il{Neuhochdeutsch} und nimmt weitere Verfeinerungen ihrer Theorie
...
\REF{fig:hebrqf}. Anders als im Deutschen\il{Neuhochdeutsch} oder im

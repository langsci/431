...
bezeichneten\is{Denotation} Person gebunden; bei Dingen und Abstrakta ergeben
...
\norm{bėide} `beide' als \isi{Target} gleichermaßen bezieht. Dies ist in der
...
So bezieht sich \lit{ſi beidv̍} `sie beide (\textsc{n})' dort gleichermaßen auf

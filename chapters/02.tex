...
\begin{exe}
	...
	\sn \gll Si ligent bede f\sscr{v}{e}r tot \\
...
\ex \label{ex:nongenmasc}
	\gll Hermann der Marſpurrer \textelp{} vnd C\sscr{v}{o}nrat der Turſte
...
\lit{R\sscrit{v}{o}diger} \wdef{Rüdiger (\MascM)} und seine \lit{hovſfrowe} \wdef{Ehefrau
...
\begin{exe}
	\ex \label{ex:askfmbeidiu}
		\begin{xlist}
		\ex \gll vnſer m\sscr{o}{v}ter iwer frîundin. \\
...
\ex\label{ex:disjointctrl_1}
	...
	\gll % das
			...
			% het gegeben ze c\sscr{o}{u}ffenne \textelp{}
...
\ex\label{ex:disjointctrl_2}
	\gll dv̓ vorgenante fro Mehthilt\tsub{i} / vor e ſi\tsub{i} den
			...
			% ſo iſt daſ vorgenante g\sscr{u}{o}t \textelp{} {dem ſelben} ſpittal vn̄
